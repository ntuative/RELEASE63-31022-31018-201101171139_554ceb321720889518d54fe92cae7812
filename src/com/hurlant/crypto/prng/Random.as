   ...
   public class Random
   {
      ...
      public function Random(param1:Class = null)
      {
         ...
         while(this.var_102 < this.psize)
         {
            ...
            this.var_139[_loc3_] = _loc2_ >>> 8;
            var _loc4_:*;
            this.var_139[_loc4_ = this.var_102++] = _loc2_ & 255;
         }
         this.var_102 = 0;
         this.seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         this.var_139[_loc2_] ^= param1 & 255;
         var _loc3_:* = this.var_102++;
         this.var_139[_loc3_] ^= param1 >> 8 & 255;
         var _loc4_:*;
         this.var_139[_loc4_ = this.var_102++] = this.var_139[_loc4_] ^ param1 >> 16 & 255;
         var _loc5_:*;
         this.var_139[_loc5_ = this.var_102++] = this.var_139[_loc5_] ^ param1 >> 24 & 255;
      ...
      public function nextByte() : int
      {
         if(!this.ready)
         {
            ...
            this.state.init(this.var_139);
            this.var_139.length = 0;
            this.var_102 = 0;
            this.ready = true;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_139[_loc1_] = Math.random() * 256;
            _loc1_++;
         }
         this.var_139.length = 0;
         this.var_139 = null;
