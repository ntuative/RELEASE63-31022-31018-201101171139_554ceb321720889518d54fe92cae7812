package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1069:int = 2;
      ...
      private var var_153:IRoomManagerListener;
      
      private var var_2776:IRoomContentLoader;
      
      private var var_619:IRoomObjectFactory = null;
      
      private var var_507:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1171:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_518,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_595,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_619 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_619 == null || this.var_507 == null)
         {
            return;
         }
         this._state = const_1568;
         if(this.var_1171 != null)
         {
            _loc1_ = this.var_1171;
            this.var_1171 = null;
            this.initialize(_loc1_,this.var_153);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_618.indexOf(_loc5_) < 0)
            {
               this.var_48.loadObjectContent(_loc5_,events);
               this.var_618.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_596.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_596[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_619.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_619 != null)
         {
            return this.var_619.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_721)
         {
            return;
         }
         if(this.var_48 == null)
         {
            this._state = const_721;
            return;
         }
         if(this.var_48.getGraphicAssetCollection(param1) != null)
         {
            ...
            if(this.var_618.length == 0)
            {
               ...
               {
                  this.var_153.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_721;
            this.var_153.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_153 != null)
            {
               this.var_153.contentLoaded(null,false);
            }
            return;
         }
         ...
         if(_loc3_ == null)
         {
            if(this.var_153 != null)
            {
               this.var_153.contentLoaded(_loc2_,false);
            }
            return;
         }
         ...
         if(this.var_153 != null)
         {
            this.var_153.contentLoaded(_loc2_,true);
         }
         if(this.var_618.length > 0)
         {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_48 == null || this.var_507 == null)
         {
            return;
         }
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_619.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(this.var_153 != null)
                                 {
                                    this.var_153.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
