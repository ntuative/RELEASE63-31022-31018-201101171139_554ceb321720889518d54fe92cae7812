package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1627:int = 50;
      ...
      private var var_463:Point;
      
      private var var_230:BitmapDataCache;
      
      private var var_552:RoomObjectCache;
      
      private var var_462:Array;
      
      private var var_555:Array;
      
      private var var_1275:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2194:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_231.addChild(this.var_53);
         ...
         this.var_552 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_463.x -= param1 - this.var_554;
         this.var_554 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_463.y -= param1 - this.var_556;
         this.var_556 = param1;
      }
      ...
      {
         this.var_552.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_677 != this.var_2192 || this._ht != this.var_2195)
         {
            _loc9_ = true;
         }
         if(this.var_53.x != this.var_554 || this.var_53.y != this.var_556)
         {
            this.var_53.x = this.var_554;
         ...
         this.var_462.sortOn("z",0 | 0);
         if(_loc5_ < this.var_462.length)
         {
            this.var_462.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_462[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2192 = this.var_677;
         this.var_2195 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_552.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_552.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_554;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_556;
                  if(_loc19_ < this.var_677 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_462.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_554;
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_678 || this.var_678 == 0)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_462.length)
         {
            return null;
         }
         return this.var_462[param1] as SortableSprite;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_554;
         param2 -= this.var_556;
         this.var_463.x = param1;
         this.var_463.y = param2;
         if(this.var_1040 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1596;
         }
         this.var_1596 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1040;
         return this.var_1596;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_677 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1595,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2193 || param2 != this.var_2194)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         while(_loc1_ < this.var_317.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1275.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1040 == 0)
         {
            this.checkMouseHits(this.var_463.x,this.var_463.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1040 = 0;
         ++this.var_1595;
      }
