package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1240:int = 128;
      
      private var var_1241:Boolean = false;
      
      private var var_2713:Point;
      ...
      {
         if(param1 != this.var_1513 || param2 != this.var_1514)
         {
      ...
      {
         if(this.var_1240 > 255 || bitmapData == null)
         {
            return false;
         }
