   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_250 != null)
         {
            ...
            {
               _loc3_ = this.var_250.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1365.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         ...
         if(this.var_585[param1] != param2)
         {
            this.var_585[param1] = param2;
         }
      }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_596.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_596[_loc2_]);
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         {
            return this.var_250.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_250.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_250.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_250.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_250.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
