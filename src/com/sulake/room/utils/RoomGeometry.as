package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_739:Number = 64;
      
      public static const const_1118:Number = 32;
      ...
      private var var_1797:Number = 1.0;
      
      private var var_1799:Number = 1.0;
      
      private var var_1798:Number = 1.0;
      
      private var var_76:Vector3d;
      
      private var var_253:Vector3d;
      
      private var var_2739:Number = -500.0;
      
      private var var_2738:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1798 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_172.x,this.var_172.y,this.var_172.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_76.x * this.var_410,this.var_76.y * this.var_409,this.var_76.z * this.var_408);
      }
      ...
      {
         if(this.var_410 != param1 * this.var_1797)
         {
            this.var_410 = param1 * this.var_1797;
            ++this.var_150;
         }
      }
      ...
      {
         if(this.var_409 != param1 * this.var_1799)
         {
            this.var_409 = param1 * this.var_1799;
            ++this.var_150;
         }
      }
      ...
      {
         if(this.var_408 != param1 * this.var_1798)
         {
            this.var_408 = param1 * this.var_1798;
            ++this.var_150;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_76.x /= this.var_410;
         this.var_76.y /= this.var_409;
         this.var_76.z /= this.var_408;
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_497 != null)
         {
            ...
            this.var_497.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_497.add(_loc3_,_loc4_);
            ++this.var_150;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_497 != null)
         {
            ...
            return this.var_497.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1143.assign(_loc22_);
         }
         else
         {
            this.var_1143.assign(_loc17_);
         }
         ++this.var_150;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.z *= this.var_408;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1143);
         if(_loc3_ < this.var_2739 || _loc3_ > this.var_2738)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_409;
            _loc2_.z *= this.var_408;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1143);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_173,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_76.x * this.var_410,this.var_76.y * this.var_409,this.var_76.z * this.var_408);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_172;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_410,param2.y * this.var_409,param2.z * this.var_408);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_410,param3.y * this.var_409,param3.z * this.var_408);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_410,param4.y * this.var_409,param4.z * this.var_408);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1118;
         }
         else
         {
            this.scale = const_739;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_739;
      }
