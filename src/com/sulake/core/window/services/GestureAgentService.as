package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_188:Timer;
      
      protected var var_1458:uint = 0;
      
      protected var var_261:Function;
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         {
            this._window = param1;
            this._window.addEventListener(WindowEvent.const_265,this.clientWindowDestroyed);
            this.var_261 = param2;
            this._working = true;
            this.var_1209 = param4;
            this.var_1210 = param5;
            this.var_188 = new Timer(40,0);
            this.var_188.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_188.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         ...
         else if(this.var_261 != null)
         {
            this.var_261(this.var_1209,this.var_1210);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_188.stop();
            this.var_188.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_188 = null;
         }
         if(this._working)
         {
            if(this._window == param1)
            {
               ...
               {
                  this._window.removeEventListener(WindowEvent.const_265,this.clientWindowDestroyed);
               }
               this._window = null;
               this._working = false;
            }
