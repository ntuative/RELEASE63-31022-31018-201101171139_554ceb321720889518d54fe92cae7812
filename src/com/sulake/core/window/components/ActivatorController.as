package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         else if(param2.type == WindowNotifyEvent.const_603)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_781;
         if(this.var_781 != param1)
         {
            if(this.var_781 != null)
            {
               if(!this.var_781.disposed)
               {
                  this.var_781.deactivate();
               }
            }
            this.var_781 = param1;
