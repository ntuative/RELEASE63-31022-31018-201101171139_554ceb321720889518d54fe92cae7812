package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1168:Dictionary = createPropertySetterTable();
      
      protected static const const_1608:Array = [AntiAliasType.ADVANCED,AntiAliasType.NORMAL];
      
      protected static const const_1607:Array = [GridFitType.PIXEL,GridFitType.NONE,GridFitType.SUBPIXEL];
      
      protected static const const_1606:Array = [TextFieldAutoSize.NONE,TextFieldAutoSize.LEFT,TextFieldAutoSize.RIGHT,TextFieldAutoSize.CENTER];
      ...
      protected var var_523:Boolean;
      
      protected var var_36:TextMargins;
      
      protected var var_428:String = "none";
      
      protected var var_115:Boolean = false;
      
      protected var var_967:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_412,this._explicitStyle);
      ...
      private static function setTextMarginMap(param1:TextController, param2:Map) : void
      {
         if(param1.var_36)
         {
            param1.var_36.assign(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         else
         {
            param1.var_36 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         param1.refreshTextImage();
      }
      ...
      {
         if(param1.var_36 && param1.var_36.left != param2)
         {
      ...
      {
         if(param1.var_36 && param1.var_36.top != param2)
         {
      ...
      {
         if(param1.var_36 && param1.var_36.right != param2)
         {
      ...
      {
         if(param1.var_36 && param1.var_36.bottom != param2)
         {
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_412 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_412,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_162);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_669 ? true : null;
         }
      ...
      {
         this.var_785 = param1;
         this._field.scrollH = this.var_785 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_785 * this.maxScrollH,this.var_522 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_36 = this.var_36.clone(_loc1_.setTextMargins);
         _loc1_.var_428 = this.var_428;
         _loc1_.var_115 = this.var_115;
         return _loc1_;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!this.var_523)
         {
            if(param2.type == WindowNotifyEvent.const_184)
            {
      ...
      protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         this.var_523 = true;
         var _loc2_:int = this.var_36.left + this.var_36.right;
         var _loc3_:int = this.var_36.top + this.var_36.bottom;
         ...
         if(_loc6_ != _loc4_)
         {
            if(this.var_428 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_11.x,var_11.y,_loc6_ + _loc2_,Math.floor(this._field.height) + _loc3_);
               _loc7_ = true;
            }
            else if(this.var_428 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_11.x,var_11.y,_loc6_ + _loc2_,Math.floor(this._field.height) + _loc3_);
               _loc7_ = true;
            }
            else if(this.var_428 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(this.var_428 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_11.x,var_11.y,_loc6_ + _loc2_,Math.floor(this._field.height) + _loc3_);
               _loc7_ = true;
            }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:Object = TextStyleManager.getStyle(this.var_412);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_226,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(new PropertyStruct("text_color",this._field.textColor,PropertyStruct.const_141,this._field.textColor != _loc2_.color));
         _loc1_.push(new PropertyStruct("antialias_type",this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != AntiAliasType.ADVANCED,const_1608));
         ...
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_141,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",this._field.gridFitType,PropertyStruct.const_53,this._field.gridFitType != GridFitType.PIXEL,const_1607));
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_223,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_223,this._field.thickness != 0));
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_38,this._field.wordWrap != false));
         _loc1_.push(new PropertyStruct("auto_size",this.var_428,PropertyStruct.const_53,this.var_428 != TextFieldAutoSize.NONE,const_1606));
         ...
         if(this._field.mouseWheelEnabled != PropertyDefaults.const_1038)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_806,this._field.mouseWheelEnabled,PropertyStruct.const_38,true));
         }
         else
         {
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_223,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
