package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_366:IScrollbarWindow;
      
      private var var_1476:Boolean = true;
      ...
      override public function dispose() : void
      {
         if(this.var_366)
         {
            this.var_366.removeEventListener(WindowEvent.const_289,this.scrollBarEventProc);
            this.var_366.removeEventListener(WindowEvent.const_233,this.scrollBarEventProc);
            this.var_366 = null;
         }
         if(this.var_977)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_366)
         {
            this.var_366 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_366)
            {
               this.var_366.addEventListener(WindowEvent.const_289,this.scrollBarEventProc);
               this.var_366.addEventListener(WindowEvent.const_233,this.scrollBarEventProc);
            }
         }
         return this.var_366;
      }
      ...
      public function set method_8(param1:Boolean) : void
      {
