   ...
   public class ScrollbarLiftController extends InteractiveController implements IDragBarWindow
   {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(param2.type == WindowNotifyEvent.const_433)
         {
            ...
            this.var_1029 = y != 0 ? Number(y / Number(0 - height)) : Number(0);
            if(_parent != this._scrollBar)
            {
               this._scrollBar.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_275,this,null));
            }
         }
