package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_391:String = "_DROPMENU_TITLETEXT";
      ...
      {
         if(param1 > this.var_226.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_498,this,null,true);
         this.update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_535 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_376,this,null));
         }
      }
      ...
      {
         return getChildByName(DropMenuController.const_391) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_156 == null || this.var_156.disposed)
         {
            this.var_156 = context.create(name + "::submenu","",WindowType.const_548,var_78,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_226.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_808 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_808)
         {
            if(this.open())
            {
               if(this.var_226.length)
               {
                  this.populateMenuItemContainer(this.var_226,this.getSubMenu(),this.subMenuEventProc);
                  this.var_808 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_808 = false;
            this.getTitleLabel().text = this.var_535 < this.var_226.length && this.var_535 > -1 ? this.var_226[this.var_535] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_472,var_78,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_333,var_78,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_535 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_535).setStateFlag(WindowState.WINDOW_STATE_SELECTED,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_42 || param1.type == WindowTouchEvent.const_448)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1105:
            case WindowMouseEvent.const_58:
               ...
               break;
            case WindowTouchEvent.const_854:
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_226[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_226.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_588,this.var_226,PropertyStruct.const_116,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1348);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_588)
            {
