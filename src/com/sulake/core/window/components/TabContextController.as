package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1284:String = "_SELECTOR";
      
      private static const const_1285:String = "_CONTENT";
       
      
      protected var var_966:ITabSelectorWindow;
      
      protected var var_1961:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_966 = findChildByTag(const_1284) as ITabSelectorWindow;
            if(this.var_966 != null)
            {
               this.var_966.procedure = this.selectorEventProc;
            }
         }
         return this.var_966;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1961 = findChildByTag(const_1285) as IWindowContainer;
         }
      ...
      {
         return !!this.var_724 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_966.numSelectables;
      }
