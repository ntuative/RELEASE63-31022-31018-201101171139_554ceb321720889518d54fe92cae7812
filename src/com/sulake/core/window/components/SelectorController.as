package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_180:ISelectableWindow;
      
      protected var var_1942:Boolean = true;
      ...
      {
         return this.var_180 as ISelectableWindow;
      }
         ...
         if(param1 != null)
         {
            if(param1 != this.var_180)
            {
               ...
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_376,this,this.var_180));
               }
            }
         }
      }
