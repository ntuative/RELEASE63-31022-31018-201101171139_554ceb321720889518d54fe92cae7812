package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1272:String = "increment";
      
      private static const const_1271:String = "decrement";
      
      private static const const_911:String = "slider_track";
      
      private static const const_579:String = "slider_bar";
      ...
      {
         return findChildByName(const_911) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_579) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_579:
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_42 || param1.type == WindowTouchEvent.const_448)
         {
            ...
            else if(param2.name == const_1271)
            {
               if(this.var_18)
               {
                  this.var_1131 = true;
            ...
            else if(param2.name == const_911)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_579).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
