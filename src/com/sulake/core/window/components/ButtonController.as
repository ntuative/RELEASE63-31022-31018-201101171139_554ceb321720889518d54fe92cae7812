package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_391:String = "_BTN_TEXT";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = getChildByName(const_391);
         if(_loc2_ != null)
         {
         ...
         if(event is WindowNotifyEvent)
         {
            switch(event.type)
            {
               ...
               case WindowNotifyEvent.const_649:
                  try
                  {
                     getChildByName(const_391).blend = getChildByName(const_391).blend + 0.5;
                  }
                  catch(e:Error)
                  {
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_1105:
                  type = "null";
                  break;
               case WindowTouchEvent.const_448:
                  type = "null";
            }
