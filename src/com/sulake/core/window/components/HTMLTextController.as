package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_927:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1810:StyleSheet = null;
      ...
      {
         this.var_745 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1145 == param2)
         {
            return;
         }
         param1.var_1145 = param2;
         param1.var_1810 = null;
         if(param1.var_1145 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1145);
            param1.var_1810 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_672.indexOf(param1) > -1)
         {
            this.var_745 = param1;
         }
      }
      ...
      {
         return this.var_745 == LinkTarget.const_30 ? defaultLinkTarget : this.var_745;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_1810;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_745 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_659,this.var_745,PropertyStruct.const_53,true,PropertyDefaults.const_672));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1402);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_659)
            {
               this.var_745 = _loc2_.value as String;
               break;
            }
