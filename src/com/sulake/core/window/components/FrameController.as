package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1223:String = "_TITLE";
      
      private static const const_1225:String = "_HEADER";
      
      private static const const_1226:String = "_CONTENT";
      
      private static const const_1224:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1322:IHeaderWindow;
      
      private var var_166:IWindowContainer;
      
      private var var_36:IMargins;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1223) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1322 = findChildByTag(const_1225) as IHeaderWindow;
            if(!this.var_1322)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_166 = findChildByTag(const_1226) as IWindowContainer;
            if(!this.var_166)
            {
      ...
      {
         return findChildByTag(const_1224) as IScalerWindow;
      }
      ...
      public function get margins() : IMargins
      {
         ...
         if(!this.var_36)
         {
            ...
            this.var_36 = new TextMargins(_loc1_.left,_loc1_.top,_loc1_.right,_loc1_.bottom,this.marginsCallback);
         }
         return this.var_36;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1167,_loc2_,false);
      ...
      {
         return this.content != null && this.var_965 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc4_:Boolean = testParamFlag(WindowParam.const_254);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_315,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:* = this.var_36 != null;
         var _loc3_:Rectangle = this.content.rectangle;
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_310,_loc3_.left,PropertyStruct.const_36,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_281,_loc3_.top,PropertyStruct.const_36,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_293,0 - _loc3_.right,PropertyStruct.const_36,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_283,0 - _loc3_.bottom,PropertyStruct.const_36,_loc2_));
         }
         else
         {
