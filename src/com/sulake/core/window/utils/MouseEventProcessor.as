package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_780:IWindowContextStateListener;
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_236;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this._lastClickTarget = param1.var_1193 as WindowController;
         this.var_149 = param1.renderer;
         this.var_780 = param1.var_1192;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_634.x || _loc3_.stageY != this.var_634.y)
            {
               this.var_634.x = _loc3_.stageX;
               this.var_634.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_131.groupParameterFilteredChildrenUnderPoint(this.var_634,_loc6_,WindowParam.const_28);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_77 != this.var_131 && !this.var_77.disposed)
                  {
                     ...
                     this.var_77 = WindowController(this.var_131);
                  }
               }
            }
            while(--_loc4_ > -1)
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_77 && !this.var_77.disposed)
                     {
                        ...
                        {
                           this.var_780.mouseEventReceived(_loc3_.type,this.var_77);
                        }
                     }
                  }
         ...
         param1.var_1193 = this._lastClickTarget;
         param1.renderer = this.var_149;
         param1.var_1192 = this.var_780;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_546))
         {
