package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_162:String = "regular";
      
      public static const ITALIC:String = "italic";
      
      public static const BOLD:String = "bold";
      
      private static var var_83:Map;
      
      private static var var_483:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_573:String = "{";
      
      private static const const_574:String = "}";
      
      private static const const_1238:String = "/*";
      
      private static const const_1239:String = "*/";
      ...
      {
         return var_83.getWithIndex(param1);
      }
      
      public static function setStyle(param1:String, param2:TextStyle) : void
      {
         var _loc3_:* = var_83.getKeys().indexOf(param1) == -1;
         param2.name = param1;
         var_83[param1] = param2;
         if(_loc3_)
         {
            var_483.push(param1);
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_83[const_162],var_83[ITALIC],var_83[BOLD]];
            var_83.reset();
            var_83[const_162] = _loc5_[0];
            var_83[ITALIC] = _loc5_[1];
            var_83[BOLD] = _loc5_[2];
         }
         var _loc3_:int = 0;
         for each(_loc4_ in param1)
         {
            var_83[_loc4_.name] = _loc4_;
            if(var_483.indexOf(_loc4_.name) == -1)
            {
               var_483.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
         if(var_83.length != _loc3_)
         {
            _eventDispatcher.dispatchEvent(new Event(Event.ADDED));
         }
      }
      ...
      public static function enumerateStyles() : Array
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_.push(var_83.getWithIndex(_loc3_));
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "OutfitView" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_574);
         if(countSubStrings(param1,const_573) != countSubStrings(param1,const_574))
         {
            throw new Error("Mismatching amount of \"" + const_573 + "\" versus \"" + const_574 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1238) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1239) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_573)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
