package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1458:uint = 0;
      
      public static const const_646:uint = 1;
      
      public static const const_1163:uint = 2;
      
      public static const const_632:uint = 4;
      
      public static const const_1470:uint = 8;
      
      public static const const_1332:uint = 16;
      
      public static const const_1860:uint = 64;
      
      public static const const_1780:uint = 128;
      
      public static const const_1065:uint = 256;
      
      protected static var var_525:uint = 0;
      
      protected static var var_300:uint = 0;
       
      
      protected var var_193:DisplayObjectContainer;
      
      protected var var_1957:Boolean;
      
      protected var var_783:Boolean;
      
      protected var _disposed:Boolean = false;
      
      protected var var_11:Rectangle;
      
      protected var var_177:Shape;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_193.numChildren > 0)
               {
                  this.var_193.removeChildAt(0);
               }
            }
            this.var_193 = null;
            while(numChildren > 0)
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_177)
            {
               this.var_177 = new Shape();
               this.var_177.visible = false;
               this.var_177.cacheAsBitmap = true;
               super.addChild(this.var_177);
            }
            this.var_177.graphics.clear();
            this.var_177.graphics.beginFill(255);
            this.var_177.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_177.graphics.endFill();
            this.getDisplayObject().mask = this.var_177;
         }
         else if(this.var_177)
         {
            super.removeChild(this.var_177);
            this.var_177.graphics.clear();
            this.var_177 = null;
         ...
         if(this.var_783)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_300 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1957,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1957,16777215);
                  }
                  var_300 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_783)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_300 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_193 == null)
         {
            this.var_193 = new Sprite();
            this.var_193.name = this.name + " - Child Container";
            this.var_193.mouseEnabled = false;
      ...
      {
         return this.var_193 != null ? int(this.var_193.numChildren) : 0;
      }
