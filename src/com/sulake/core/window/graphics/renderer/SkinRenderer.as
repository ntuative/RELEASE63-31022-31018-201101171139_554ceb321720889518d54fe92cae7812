package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_362:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            this.var_518 = null;
            this.var_424 = null;
            for(_loc1_ in this.var_362)
            {
               ISkinTemplate(this.var_362[_loc1_]).dispose();
               delete this.var_362[_loc1_];
            }
            this.var_362 = null;
      ...
      {
         var _loc3_:ISkinTemplate = this.var_362[param2];
         if(_loc3_ == null)
         {
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_362[param1.name];
         if(param1 != null)
         {
            for(_loc2_ in this.var_424)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_424[_loc3_] == param1)
               {
      ...
      {
         this.var_362[param1.name] = param1;
         return param1;
      }
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_362[param1.name];
         }
         return param1;
      }
   }
