package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1118:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1167:String = "_COLORIZE";
      
      protected static const const_1600:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1357:Point = new Point();
      ...
      protected var var_637:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            ...
            var_57 = var_364.clone();
            var_11 = var_364.clone();
         ...
         if(_loc13_)
         {
            var_645 = _loc13_.blend;
            var_430 = _loc13_.treshold;
            if(var_429 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_221 != _loc13_.color)
            {
      ...
      public static function resizeToAccommodateChildren(param1:WindowController, param2:Boolean = true) : void
      {
         ...
         if(_loc9_)
         {
            ...
            if(param2)
            {
               ...
               while(_loc3_ < _loc10_)
               {
                  _loc12_ = param1.testParamFlag(WindowParam.const_90);
                  if(_loc12_)
                  {
      ...
      {
         return this.var_637 != null ? this.var_637 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_429 = param1;
         var_221 = !!var_429 ? uint(var_221 | var_524) : uint(var_221 & 16777215);
         this.var_154 = this.var_154 || param1;
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_61);
      }
      ...
      {
         var_786 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_456,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_524 = param1 & 4278190080;
         var_221 = !!var_429 ? uint(param1) : uint(param1 & 16777215);
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_61);
      }
      ...
      {
         var_524 = param1 << 24;
         var_221 = !!var_429 ? uint(var_524 | var_221) : uint(16777215 & var_221);
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_61);
      }
      
      public function set blend(param1:Number) : void
      {
         var_645 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_1022);
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_78 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_468,this,null));
         }
      }
      ...
      {
         var_430 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_337 = this._parent.rectangle.clone();
               var_57.x = var_11.x;
               var_57.y = var_11.y;
               var_57.width = var_11.width;
               var_57.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_409,this,this._parent));
            }
            else
            {
               this.var_337.x = 0;
               this.var_337.y = 0;
               this.var_337.width = 0;
               this.var_337.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1053,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_646,var_11);
            this.var_21.visible = var_365;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_78,var_19,var_15,var_11,null,this.var_637,this.properties,var_787.concat(),_id) as WindowController;
         _loc2_.var_430 = var_430;
         _loc2_.var_154 = this.var_154;
         _loc2_._debug = this._debug;
         _loc2_.var_337 = this.var_337.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2457 + "]";
      }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_15.invalidate(this,param1,WindowRedrawFlag.const_61);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_453)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1133,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_815,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_184,this,null));
            }
         }
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_728))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_42:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1101;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_184:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_556,this,null));
                     if(testParamFlag(WindowParam.const_165,WindowParam.const_149))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_175,WindowParam.const_152))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
               ...
               case WindowNotifyEvent.const_433:
                  var_15.invalidate(this,var_11.union(var_57),WindowRedrawFlag.const_430);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1108,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_275,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_381:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_603,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_241,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_504:
                  var_15.invalidate(this,var_11,WindowRedrawFlag.const_1032);
                  break;
               case WindowNotifyEvent.const_468:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1600) == -1)
                     {
                        _loc8_.style = var_78;
                     }
                  }
               ...
               case WindowNotifyEvent.const_456:
                  if(!(var_19 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        var_15.invalidate(this,var_11,WindowRedrawFlag.const_430);
                     }
                  }
                  else if(var_19 & 0)
                  {
               ...
               case WindowNotifyEvent.const_556:
                  this._parent.getRegionProperties(null,this.var_337);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_965:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1463:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_241:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1108:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_275:
               _loc2_ = "null";
         ...
         if(_loc2_ == WindowEvent.const_147)
         {
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_430);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_430);
      }
         ...
         if(this.var_154 && var_430 > 0)
         {
            if(!testParamFlag(WindowParam.const_31))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1357,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1357,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_133,WindowParam.const_149);
         var _loc2_:* = !testParamFlag(WindowParam.const_140,WindowParam.const_152);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_337.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_337.height;
               _loc5_ = uint(var_19 & 0);
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1119 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_335,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1119 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_847,this,param1));
         return param1;
      }
