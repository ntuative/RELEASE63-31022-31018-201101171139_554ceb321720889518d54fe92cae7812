package com.sulake.core.runtime
{
   ...
   public class ComponentContext extends Component implements IContext
   {
      ...
      protected function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.removeLibraryLoader(_loc2_);
         this.error("Failed to download component resource \"" + _loc2_.url + "\"!" + "\r" + _loc3_,true,Core.const_1515);
      }
         ...
         while(i < componentList.length())
         {
            ...
            if(assetCount > 0)
            {
               ...
               while(k < assetCount)
               {
                  ...
                  {
                     this.error("Manifest for component " + componentString + " contains broken asset \"" + assetName + "\"!",true,Core.const_640);
                  }
                  k++;
               }
            }
            componentString = item.attribute("PollContentDialog");
            ...
            if(componentClass == null)
            {
               this.error("Invalid component class " + componentString + "!",true,Core.const_640);
               return null;
            }
            ...
            if(component != null)
            {
               if(assetLibrary != null)
               {
                  if(component.assets != assetLibrary)
                  {
                     ...
                     this.error("Component \"" + componentString + "\" did not save provided asset library!",true,Core.const_640);
                  }
               }
               ...
               while(j < interfaceList.length())
               {
                  ...
                  method_1(component).insert(new InterfaceStruct(iid,component));
                  iidList.push(iid);
                  j++;
               }
      ...
      public final function attachComponent(param1:Component, param2:Array) : void
      {
         ...
         if(param1.locked)
         {
            param1.events.addEventListener(const_392,this.lockEventHandler);
         }
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            if(method_1(param1).find(_loc5_) == null)
            {
               method_1(param1).insert(new InterfaceStruct(_loc5_,param1));
            }
            method_1(this).insert(new InterfaceStruct(_loc5_,param1));
            _loc3_++;
         }
         if(!param1.locked)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:InterfaceStructList = method_1(this);
         ...
         while(_loc5_ < this._components.length)
         {
            if(this._components[_loc5_] == param1)
            {
               ...
               param1.events.removeEventListener(const_392,this.lockEventHandler);
               return;
            }
            _loc5_++;
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:InterfaceStruct = method_1(this).getStructByInterface(param1);
         if(_loc3_ != null)
         {
      ...
      protected final function announceInterfaceAvailability(param1:IID, param2:Component) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(_loc4_ == null)
            {
               this.error("Interface " + param1 + " still unavailabe!",true,Core.const_1362);
            }
      ...
      private function lockEventHandler(param1:LockEvent) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1.type == const_392)
         {
            _loc2_ = param1.unknown as Component;
            _loc2_.events.removeEventListener(const_392,this.lockEventHandler);
            if(!disposed)
            {
               _loc3_ = new Array();
               method_1(this).mapStructsByImplementor(_loc2_,_loc3_);
      ...
      override public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc8_:uint = method_1(this).mapStructsByImplementor(this,_loc7_);
         var _loc9_:int = 0;
         while(_loc9_ < _loc8_)
         {
