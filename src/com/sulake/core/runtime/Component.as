package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_392:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_1856:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_940:uint = 4;
       
      
      protected var var_640:uint = 0;
      
      protected var var_1199:String = "";
      
      protected var var_1949:String = "";
      ...
      private var var_473:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_473 = new InterfaceStructList();
      ...
      public static function method_1(param1:Component) : InterfaceStructList
      {
         return param1.var_473;
      }
      ...
      {
         var _loc3_:InterfaceStruct = this.var_473.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_473.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1199 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1199);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1458 & const_940)
         {
            if(_loc3_ == 0)
            {
               if(this.var_473.getTotalReferenceCount() == 0)
               {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_861 = false;
            this._events.dispatchEvent(new LockEvent(const_392,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_640 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_473.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_473.getStructByIndex(_loc8_);
