package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_438:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_438 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_109 is BitmapDataAsset)
         {
            ...
            this.var_1384 = BitmapDataAsset(this.var_109).var_1384;
            this.var_1383 = BitmapDataAsset(this.var_109).var_1383;
            if(this._bitmap != null)
            {
               this.var_109 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1384 = _loc4_ == "1" || _loc4_ == "OutfitView";
                  break;
               case "flipV":
                  this.var_1383 = _loc4_ == "1" || _loc4_ == "OutfitView";
                  break;
            }
            _loc2_++;
         }
