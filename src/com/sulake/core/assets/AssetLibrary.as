package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1087:String = "AssetLibraryReady";
      
      public static const const_698:String = "AssetLibraryLoaded";
      
      public static const const_1548:String = "AssetLibraryUnloaded";
      
      public static const const_1577:String = "AssetLibraryLoadError";
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_481;
         this.var_393 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_886.splice(var_886.indexOf(this),1);
            --var_481;
            this.var_482 = null;
            this.var_884 = null;
            this.var_145 = null;
      ...
      {
         if(this._file == param1.url && this.var_885)
         {
            if(!this.var_887 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_718,this.var_577);
            }
            this.var_887 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1087));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_885 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1548));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_884[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_970,this.assetLoadEventHandler);
      ...
      {
         return this.var_145[param1] != null || (this.var_577 != null ? this.var_577[param1] != null : false);
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_393.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_393[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(this.var_393[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_393)
         {
            _loc3_ = AssetTypeDeclaration(this.var_393[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_393)
         {
            _loc4_ = AssetTypeDeclaration(this.var_393[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1577));
         this.var_38 = null;
      }
