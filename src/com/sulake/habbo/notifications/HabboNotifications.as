package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1174:String = "pixelbalance";
      
      private static const const_1175:String = "badges";
      
      private static const const_1179:String = "selectbadge";
      
      private static const const_1176:String = "inventory";
      
      private static const const_1180:String = "selectfurni";
      
      private static const const_1178:String = "credits";
      
      private static const const_1173:String = "friendlist";
      
      private static const const_1177:String = "pet_inventory";
      ...
      private var var_643:IHabboToolbar;
      ...
      private var var_436:HabboNotificationViewManager;
      ...
      private var var_794:ClubGiftNotification;
      
      private var var_791:ClubEndingNotification;
      
      private var var_793:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_792);
         }
         var _loc6_:Map = this.var_792["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_643)
         {
            this.var_643.release(new IIDHabboToolbar());
            this.var_643 = null;
         }
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_792["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_195 = new HabboAlertDialogManager(this._windowManager,this._localization);
      ...
      {
         this.var_643 = IHabboToolbar(param2);
         this.var_643.events.addEventListener(HabboToolbarEvent.const_70,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_70)
         {
            ...
            this.var_436 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_792["styles"],this.var_792["view"],this.var_643);
            ...
            this._communication.addHabboConnectionMessageEvent(new UserBannedMessageEvent(this.method_7));
            ...
            registerUpdateReceiver(this.var_436,1);
            registerUpdateReceiver(this,2);
            this.var_367.events.addEventListener(BadgeImageReadyEvent.const_127,this.onBadgeImage);
            this.var_643.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1226[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_367);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1573);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_367.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1159);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1159);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1401);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_433.createAvatarImage(param2,AvatarScaleType.const_48);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = this.var_367.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_79)
               {
                  _loc9_ = this.var_367.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = this.getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = this.var_367.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1331,_loc5_);
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1096)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1314);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1539)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_791 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_793 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function onInfoFeedEnable(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1481 = !_loc2_.enabled;
         }
      }
      
      public function update(param1:uint) : void
      {
         if(this.var_436.isSpaceAvailable() && this.var_981.length > 0)
         {
            this.var_436.showItem(this.getNextItemFromQueue());
         }
      }
      ...
      {
         if(param1 != null && this.var_436 != null)
         {
            this.var_436.replaceIcon(param1);
         }
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_195 == null)
         {
            return;
         }
         this.var_195.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function method_7(param1:IMessageEvent) : void
      {
         ...
         this.var_195.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_195.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_195.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_195.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_433.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_48);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1023,_loc5_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_433.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_48);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_1991)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1066);
            this.var_1991 = true;
      ...
      {
         if(param2.type == WindowEvent.const_177 || param2.type == WindowEvent.const_750)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_794 && this.var_794.visible)
         {
            return;
         }
         this.var_794 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
