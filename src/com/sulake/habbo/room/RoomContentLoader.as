package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_830:String = "RCL_LOADER_READY";
      
      private static const const_316:String = "RCL_PUBLICROOM_";
      
      private static const const_1611:int = 0;
      
      private static const const_871:int = 1;
      
      private static const name_2:int = 2;
      
      private static const const_394:String = "place_holder";
      
      private static const const_563:String = "wall_place_holder";
      
      private static const const_1194:String = const_394;
      
      private static const ROOM_CONTENT:String = "room";
      
      private static const const_869:String = "tile_cursor";
      ...
      private var var_1237:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         this.var_531 = [];
         this._wallItems = [];
         this.var_2014 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2015 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2017 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2013 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2016 = param2.getKey("public.room.dynamic.download.url","");
         this.var_2019 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = this.var_367.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_442.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_442.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         {
            _loc1_ = this.var_372.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc4_ = this.var_372.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc2_.type == "s")
            {
               ...
               if(this.var_531.indexOf(_loc7_) < 0)
               {
                  this.var_531.push(_loc7_);
               }
            }
            ...
            _loc8_ = this.var_532.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_532.remove(_loc7_);
               this.var_532.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2018)
         {
            ...
            {
               this.var_1237.dispatchEvent(new Event(const_830));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_441 != null)
         {
            this.var_441.remove(param1);
            this.var_441.add(param1,param2);
         }
         if(this.var_443 != null)
         {
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_441 != null)
         {
            _loc2_ = this.var_441.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_531.indexOf(param1) >= 0)
         {
         ...
         if(this.var_178 != null && (this.var_178.type == param1 || this.var_178.hasWorldType(param1)))
         {
      ...
      {
         return [const_394,const_563,ROOM_CONTENT,const_869,const_870];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_530.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_533.getValue(param1) as String;
      ...
      {
         var _loc2_:String = this.var_533.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      {
         if(this.var_178 != null && this.var_178.hasWorldType(const_316 + param1))
         {
            return this.var_178.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_167 || param1 == RoomObjectVisualizationEnum.const_63 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc2_ == RoomObjectCategoryEnum.const_27)
         {
            ...
            return int(this.var_532.getValue(param1));
         }
         return 0;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               {
                  _loc10_ = this.var_2019;
                  _loc10_ = _loc10_.replace(/%typeid%/,_loc7_[_loc9_]);
                  _loc8_.push(this.var_2016 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
                     if(this.var_531.indexOf(_loc4_) == -1)
                     {
                        this.var_531.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_27:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1238.getValue(param1) != null)
         {
            this.var_178 = this.var_1238.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2014.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1504);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2015.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = this.getVisualizationXML(_loc5_);
               _loc8_ = this.extractPublicRoomFromXML(_loc5_,_loc7_);
               this.var_1238.add(_loc5_,_loc8_);
               this.var_178 = _loc8_;
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_518,_loc5_);
         }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_442.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = this.var_442.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_442.add(_loc5_,_loc4_);
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_206 && _loc5_ != RoomObjectLogicEnum.const_167)
         {
            _loc6_ = "@shadow";
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_372.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_372.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_372[_loc2_] != null)
         {
            _loc3_ = this.var_372.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_316 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_316 + param1) == RoomObjectCategoryEnum.const_73)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_178.getWorldHeightScale(const_316 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_178 != null)
         {
            return this.var_178.getWorldScale(const_316 + param1);
         }
         return 32;
      }
