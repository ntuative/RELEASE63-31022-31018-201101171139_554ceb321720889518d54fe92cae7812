package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1305:String = "shore";
      ...
      {
         if(this.var_2663 == param1 && this.var_2664 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,_direction,_loc2_) == const_1305)
            {
               this.var_1883 = _loc2_;
               this.var_2663 = param1;
               this.var_2664 = _direction;
               return this.var_1883;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1181.indexOf(_loc2_) < 0)
            {
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_625[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_625[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_510 == 0 || this.var_626 == 0)
         {
            ...
            this.var_510 = _loc2_.getNumber(RoomObjectVariableEnum.const_294);
            this.var_626 = _loc2_.getNumber(RoomObjectVariableEnum.const_373);
         }
         this.var_420 = [];
         this.var_625 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_510 * 2 + this.var_626 * 2)
         {
            this.var_420.push(false);
            this.var_625.push(ShoreMaskCreatorUtility.const_72);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_64,getSize(param3),this.var_420,this.var_625,assetCollection);
      }
