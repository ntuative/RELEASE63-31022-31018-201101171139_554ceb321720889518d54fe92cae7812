package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class AnimationData
   {
      ...
      public function getStartFrame(param1:int) : int
      {
         ...
         return Math.random() * this.var_377;
      }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         if(_loc11_ > this.var_377)
         {
            this.var_377 = _loc11_;
         }
         return true;
      }
      ...
      {
         var _loc4_:AnimationLayerData = this.var_110.getValue(param2) as AnimationLayerData;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc6_:AnimationLayerData = this.var_110.getValue(param2) as AnimationLayerData;
         if(_loc6_ != null)
         {
