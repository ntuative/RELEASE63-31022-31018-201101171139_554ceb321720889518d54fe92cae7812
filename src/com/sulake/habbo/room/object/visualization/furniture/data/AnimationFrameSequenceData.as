package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationFrameSequenceData
   {
      ...
      {
         return this.var_375.length * this._loopCount;
      }
      ...
      public function initialize() : void
      {
         var _loc1_:int = 1;
         var _loc2_:int = -1;
         var _loc3_:int = this.var_375.length - 1;
         while(_loc3_ >= 0)
         {
            if(this.var_375[_loc3_] == _loc2_)
            {
               _loc1_++;
            }
            else
            {
               _loc2_ = this.var_375[_loc3_];
               _loc1_ = 1;
            }
      ...
      public function addFrame(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         this.var_375.push(this._frames.length - 1);
         this.var_870.push(1);
      }
      ...
      public function getFrame(param1:int) : AnimationFrameData
      {
         ...
         if(this.var_1562)
         {
            param1 = Math.random() * this.var_375.length;
            if(param1 == this.var_375.length)
            {
               param1--;
            }
         }
         param1 = this.var_375[param1 % this.var_375.length];
