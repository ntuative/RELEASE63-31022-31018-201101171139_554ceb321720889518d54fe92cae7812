package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_198:FurnitureParticleSystem;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_198 = this.var_539[param1];
               _loc3_ = true;
            }
            else if(param1 != var_223)
            {
               if(this.var_198)
               {
                  this.var_198.reset();
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_198)
         {
            this.var_198.setAnimation(param1);
         }
      ...
      {
         if(this.var_198 && this.var_198.controlsSprite(param3))
         {
            return this.var_198.getSpriteYOffset(param1,param2,param3);
         }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1075);
         if(_loc3_.length == 0)
         {
