package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1358:IGraphicAssetCollection;
      ...
      private var var_1120:Point = null;
      
      private var var_1359:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_895)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1359 = this.var_40.getValue(this.var_895);
         }
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         this.var_1120.x = _loc3_.x;
         this.var_1120.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_40.getValue(this.var_895);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1737 = RoomObjectVariableEnum.const_964;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1737 = RoomObjectVariableEnum.const_998;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1121 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1121 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_40.getValue(this.var_895);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2460 && param3 == this.var_2459)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1121 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1121 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1737);
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1359.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_1358.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1120.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1120.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_395.indexOf(_loc10_) >= 0 && this.var_894)
            {
               param1 = this.var_395.indexOf(_loc10_);
               if(this.var_580[param1] != "")
               {
                  _loc9_ = this.var_1358.getAsset(this.var_580[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_581[param1] != -1)
               {
                  param2.alpha = this.var_581[param1];
               }
               this.var_395.splice(param1,1);
      ...
      {
         this.var_894 = true;
         var _loc3_:int = this.var_395.indexOf(param1);
         if(_loc3_ < 0)
         {
