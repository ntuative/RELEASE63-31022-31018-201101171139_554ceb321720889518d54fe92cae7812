package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_856:IPlaneRasterizer = null;
      
      private var var_653:PlaneMaskManager = null;
      
      private var _id:String = null;
      
      private var var_2303:Number = 0;
      ...
      private var var_386:PlaneBitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2306 = param11;
         this.var_2304 = param12;
         this.var_858 = param6;
      }
      ...
      {
         return this._isVisible && this.var_701;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_181 != null)
         {
            ...
            {
               _loc2_ = this.var_181.getWithIndex(_loc1_) as PlaneBitmapData;
               if(_loc2_ != null)
               {
      ...
      {
         var _loc3_:PlaneBitmapData = this.var_181.remove(param1) as PlaneBitmapData;
         if(_loc3_ != null)
         {
      ...
      private function resetTextureCache(param1:BitmapData = null) : void
      {
         ...
         if(this.var_181 != null)
         {
            ...
            {
               _loc3_ = this.var_181.getWithIndex(_loc2_) as PlaneBitmapData;
               if(_loc3_ != null)
               {
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_856.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_386;
         if(_loc3_ == null)
         {
            _loc4_ = this.getTextureIdentifier(param1.scale);
            _loc3_ = this.var_181.getValue(_loc4_) as PlaneBitmapData;
         }
         this.updateMaskChangeStatus();
         if(this.var_701 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_328))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_856 != null)
            {
               _loc3_ = this.var_856.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1641,this.var_2303,this.var_2302,this.var_2306,this.var_2304,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1586 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_701)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            originPos = geometry.getScreenPosition(this.var_1037);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_141.z - originZ,this.var_106.z - originZ,this.var_80.z - originZ,this.var_105.z - originZ);
            if(this._type == const_93)
            {
               relativeDepth += 0.02;
            }
            this.var_2173 = relativeDepth;
            this._isVisible = true;
            this.var_1586 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2305);
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_858)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_327.length)
            {
               _loc5_ = this.var_327[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_238.length == this.var_857.length)
         {
            while(_loc1_ < this.var_238.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_857[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_327.length > this.var_1315.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_858 || this.var_238.length == 0 && this.var_327.length == 0 && !this.var_328 || this.var_653 == null)
         {
            return;
         }
         ...
         if(this.var_328)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_548);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_238.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_64.width - this.var_64.width * _loc3_.leftSideLoc / this.var_276.length;
                  _loc11_ = this.var_64.height - this.var_64.height * _loc3_.rightSideLoc / this.var_277.length;
                  _loc12_ = _loc3_.type;
                  this.var_653.updateMask(this.var_64,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_857.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_327.length)
            {
               _loc4_ = this.var_327[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_64.width - this.var_64.width * _loc4_.leftSideLoc / this.var_276.length;
                  _loc11_ = this.var_64.height - this.var_64.height * _loc4_.rightSideLoc / this.var_277.length;
                  _loc13_ = this.var_64.width * _loc4_.leftSideLength / this.var_276.length;
                  _loc14_ = this.var_64.height * _loc4_.rightSideLength / this.var_277.length;
                  this.var_64.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1315.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_328 = false;
