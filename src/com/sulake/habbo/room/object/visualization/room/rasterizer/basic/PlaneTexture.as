   ...
   public class PlaneTexture
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_600 != null)
         {
            ...
            {
               _loc2_ = this.var_600[_loc1_] as PlaneTextureBitmap;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function getBitmap(param1:IVector3d) : BitmapData
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_600.length)
         {
            _loc3_ = this.var_600[_loc2_] as PlaneTextureBitmap;
            if(_loc3_ != null)
            {
