package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1528:int = 16777215;
      ...
      public static const const_1346:int = 13421772;
      
      public static const const_1486:int = 10066329;
      ...
      private var var_666:Rectangle = null;
      
      private var var_452:RoomPlaneBitmapMaskParser = null;
      
      private var var_1527:String = null;
      
      private var _floorType:String = null;
      
      private var var_1526:String = null;
      
      private var var_2127:String = null;
      
      private var var_1031:uint = 16777215;
      
      private var var_2126:int = 255;
      
      private var var_2128:int = 255;
      
      private var var_2125:int = 255;
      ...
      private const const_1908:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_452 = new RoomPlaneBitmapMaskParser();
         this.var_274["null"] = false;
         this.var_274["null"] = true;
         this.var_274["null"] = true;
         this.var_274["null"] = true;
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_123.length)
            {
               _loc4_ = this.var_123[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_666 = super.boundingRectangle;
         }
         return new Rectangle(this.var_666.x,this.var_666.y,this.var_666.width,this.var_666.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_123.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_123[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1044);
         ...
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1430)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_105,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1908 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         if(_loc7_)
         {
            ...
            {
               _loc10_ = this.var_544[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_309[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_93)
               {
                  if(this.var_1570)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2125 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2128 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2126 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1586)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1271 || _loc3_.y != this.var_2129 || _loc3_.z != this.var_2124 || param1.scale != this.var_2122))
            {
               this.var_1271 = _loc3_.x;
               this.var_2129 = _loc3_.y;
               this.var_2124 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1147);
            if(_loc3_ != this.var_2127)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2127 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_853));
            if(_loc4_ != this.var_1031)
            {
               this.var_1031 = _loc4_;
               this.var_2125 = this.var_1031 & 255;
               this.var_2128 = this.var_1031 >> 8 & 255;
               this.var_2126 = this.var_1031 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1039));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_222 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_814);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_691);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_797);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_760));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_644));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_610));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         {
            _loc5_ = this.var_123[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      {
         if(param1 != this.var_274["null"] || param2 != this.var_274["null"] || param3 != this.var_274["null"])
         {
            this.var_274["null"] = param1;
            this.var_274["null"] = param2;
            this.var_274["null"] = param3;
            this.var_309 = [];
            this.var_544 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_309;
         if(this.var_309.length == 0)
         {
            _loc6_ = this.var_123;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_309.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_194)
                        {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_274[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_309.push(_loc12_);
                        this.var_544.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1571;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_452.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         {
            _loc3_ = this.var_123[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_452.maskCount)
         {
            _loc10_ = this.var_452.getMaskType(_loc8_);
            _loc11_ = this.var_452.getMaskLocation(_loc8_);
            _loc12_ = this.var_452.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_123.length)
               {
                  _loc3_ = this.var_123[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_105 || _loc3_.type == RoomPlane.const_93 && _loc12_ == RoomPlaneBitmapMaskData.const_211)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_123[_loc18_] as RoomPlane;
