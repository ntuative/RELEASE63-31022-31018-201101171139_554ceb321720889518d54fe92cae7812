package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1339:uint = 16777215;
      
      private var var_1694:int = 255;
      
      private var var_1098:uint = 16777215;
      
      private var var_1693:int = 255;
      
      private var var_1099:int = 0;
      
      private var var_1695:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1044,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_853,16777215);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1099)
         {
            ...
            if(_loc2_ - this.var_1099 >= this.var_1695)
            {
               _loc3_ = this.var_1098;
               _loc4_ = this.var_1693;
               this.var_1099 = 0;
            }
            else
            {
               _loc7_ = this.var_1339 >> 16 & 255;
               _loc8_ = this.var_1339 >> 8 & 255;
               _loc9_ = this.var_1339 & 255;
               _loc10_ = this.var_1098 >> 16 & 255;
               _loc11_ = this.var_1098 >> 8 & 255;
               _loc12_ = this.var_1098 & 255;
               _loc13_ = (_loc2_ - this.var_1099) / this.var_1695;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1694 + (this.var_1693 - this.var_1694) * _loc13_;
               this._color = _loc3_;
               this.var_1469 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_853,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_666:
               param2.setString(RoomObjectVariableEnum.const_691,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_685:
               param2.setString(RoomObjectVariableEnum.const_814,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_767:
               param2.setString(RoomObjectVariableEnum.const_797,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_414:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_211)
               {
                  _loc5_ = "null";
               }
               this.var_452.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_592:
               _loc4_ = this.var_452.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_452.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1147,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1056:
               ...
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1029:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1039,int(param1.bgOnly));
         this.var_1339 = this._color;
         this.var_1694 = this.var_1469;
         this.var_1098 = _loc3_;
         this.var_1693 = _loc4_;
         this.var_1099 = getTimer();
         this.var_1695 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_525,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1445,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1384,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1479,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_525,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.method_2,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_145 || _loc13_ == RoomPlaneData.const_309)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
                        ...
                        _loc25_ = new RoomObjectWallMouseEvent(_loc26_,param1.method_2,_loc24_,_loc23_,_loc8_,_loc9_,_loc10_,_loc28_,_loc29_,_loc27_);
                     }
                     if(_loc25_ != null)
                     {
