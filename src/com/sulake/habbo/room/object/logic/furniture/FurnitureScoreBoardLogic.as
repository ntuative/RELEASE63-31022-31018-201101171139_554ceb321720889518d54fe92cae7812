package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_400:int = 50;
      
      private static const const_928:int = 3000;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_767 != _loc2_)
         {
            ...
            if(_loc3_ * const_400 > const_928)
            {
               this.var_1069 = const_928 / _loc3_;
            }
            else
            {
               this.var_1069 = const_400;
            }
            this.var_1439 = getTimer();
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_767 && param1 >= this.var_1439 + this.var_1069)
            {
               _loc3_ = param1 - this.var_1439;
               _loc4_ = _loc3_ / this.var_1069;
               _loc5_ = 1;
               if(this.var_767 < _loc2_)
               {
                  _loc5_ = -1;
               ...
               this.var_1439 = param1 - (_loc3_ - _loc4_ * this.var_1069);
            }
         }
      }
   }
