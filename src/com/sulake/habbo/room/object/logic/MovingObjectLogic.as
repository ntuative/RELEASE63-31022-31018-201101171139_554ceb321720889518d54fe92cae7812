package com.sulake.habbo.room.object.logic
{
   ...
   public class MovingObjectLogic extends ObjectLogicBase
   {
      ...
      public static const const_722:int = 500;
       
      
      private var var_1310:Vector3d;
      
      private var var_2763:Vector3d;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object != null)
         {
            if(param1.loc != null)
            {
               ...
               this.var_2286 = this._lastUpdateTime;
               this.var_1310 = _loc4_;
            }
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         {
            _loc2_ = param1 - this.var_2286;
            if(_loc2_ > this.var_1069)
            {
               _loc2_ = this.var_1069;
            }
            _loc3_ = Vector3d.product(this.var_1310,_loc2_ / Number(this.var_1069));
