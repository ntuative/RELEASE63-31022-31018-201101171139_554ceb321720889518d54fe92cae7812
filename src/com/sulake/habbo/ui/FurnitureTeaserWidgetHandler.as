package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_779,RoomWidgetViralFurniMessage.const_805,RoomWidgetViralFurniMessage.const_156];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_779:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_459);
                     _loc7_.data = _loc6_;
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_496,RoomSessionViralFurniStatusEvent.const_437];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_496:
               ...
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_624);
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_437:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
