package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_643);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_681);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_775);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_643:
            ...
            case RoomWidgetFriendRequestMessage.const_681:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_775:
