package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         this.var_32.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_50,this.onShowMenuEvent);
      ...
      public function dispose() : void
      {
         ...
         this.var_32.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_50,this.onShowMenuEvent);
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_50)
         {
            ...
            this.var_32.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_554));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_733 = this.var_32.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = this.var_733.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         this.var_32.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.MEMENU_ARROW,this.var_733));
      }
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_cancel":
               ...
               {
                  this.var_32.showView(TutorialUI.const_85);
               }
         }
      }
   }
