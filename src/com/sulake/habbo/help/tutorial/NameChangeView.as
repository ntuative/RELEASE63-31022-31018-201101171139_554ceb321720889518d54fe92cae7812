package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1244:uint = 13232628;
      
      private static var var_1523:uint = 11129827;
      ...
      private var var_1007:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1525 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_652)
         {
            this.var_652 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_652)
            {
               return;
            }
            this._window.content.addChild(this.var_652);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_651)
         {
            this.var_651 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_651)
            {
               return;
            }
         ...
         var _loc1_:ITextWindow = this.var_651.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_777:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_775:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_776:
               break;
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_958 || param1 == ChangeUserNameResultMessageEvent.var_957)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1007 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1007.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1244;
