package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_662:FaqCategory;
      
      private var var_661:FaqCategory;
      ...
      {
         super();
         this.var_663 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_662 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_661 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_663.hasItem(param1))
         {
            this.var_663.getItem(param1).answerText = param2;
         }
         if(this.var_662.hasItem(param1))
         {
            this.var_662.getItem(param1).answerText = param2;
         }
         if(this.var_661.hasItem(param1))
         {
            this.var_661.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_663.hasItem(param1))
         {
            return this.var_663.getItem(param1);
         }
         if(this.var_662.hasItem(param1))
         {
            return this.var_662.getItem(param1);
         }
         if(this.var_661.hasItem(param1))
         {
            return this.var_661.getItem(param1);
         }
         var _loc2_:int = 0;
