package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTextInput extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1200:int = 30;
      
      private static const const_1199:int = 253;
      
      private static const const_1201:int = 10;
      ...
      {
         main.showUI(HabboHelpViewEnum.const_171);
      }
      ...
      private function sendCallForHelp() : void
      {
         ...
         if(inputField.text.length < const_1200)
         {
