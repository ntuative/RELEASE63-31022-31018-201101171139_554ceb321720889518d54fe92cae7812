package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_826:IHabboConfigurationManager;
      
      private var var_367:ISessionDataManager;
      
      private var var_1045:FaqIndex;
      ...
      private var var_827:RegistrationUI;
      
      private var var_1278:CallForHelpData;
      
      private var var_2199:UserRegistry;
      ...
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2199 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1045 = new FaqIndex();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_287)
         {
            this.var_287.release(new IIDHabboCommunicationManager());
            this.var_287 = null;
         }
         if(this.var_826)
         {
            this.var_826.release(new IIDHabboConfigurationManager());
            this.var_826 = null;
         }
      ...
      {
         if(this.var_287 != null && param1 != null)
         {
            this.var_287.getHabboMainConnection(null).send(param1);
         }
      }
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return this.var_826.getKey(param1,param2,param3);
      }
      ...
      public function reportUser(param1:int, param2:String) : void
      {
         ...
         this.var_61.showUI(HabboHelpViewEnum.const_366);
      }
      ...
      private function createHelpUI() : Boolean
      {
         ...
         {
            this.var_61 = new HelpUI(this,this._assetLibrary,this._windowManager,this.var_825,this._toolbar);
         }
      ...
      public function initRegistrationUI() : void
      {
         if(!this.var_827)
         {
            this.var_827 = new RegistrationUI(this);
         }
         this.var_827.showRegistrationView();
      }
      ...
      {
         this.var_287 = IHabboCommunicationManager(param2);
         this._incomingMessages = new IncomingMessages(this,this.var_287);
      ...
      {
         this.var_826 = IHabboConfigurationManager(param2);
