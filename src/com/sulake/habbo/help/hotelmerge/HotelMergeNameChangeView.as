package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_652)
         {
            this.var_652 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_652)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_651)
         {
            this.var_651 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_651)
            {
               return;
            }
