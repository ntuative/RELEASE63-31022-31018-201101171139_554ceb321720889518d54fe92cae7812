package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_879:int = 0;
      
      private static const const_396:int = 1;
      ...
      {
         return this.var_540 != const_879;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1568 != RecyclerStatusMessageEvent.const_1121;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_540 == const_396;
      }
      ...
      {
         this.var_540 = const_878;
         this.var_103 = new Array(const_168);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1096:
               if(this._view != null)
               {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_103.length < const_168)
         {
            return false;
         }
         var _loc1_:int = 0;
