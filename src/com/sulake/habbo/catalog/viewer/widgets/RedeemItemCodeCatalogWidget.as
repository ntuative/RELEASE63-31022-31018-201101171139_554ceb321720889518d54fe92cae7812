package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1028.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         if(this.var_1027 != null)
         {
            this.var_1027.removeEventListener(WindowKeyboardEvent.const_148,this.windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         this.var_1028 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1028 != null)
         {
            this.var_1028.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1027 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1027 != null)
         {
            this.var_1027.addEventListener(WindowKeyboardEvent.const_148,this.windowKeyEventProcessor);
         }
      }
