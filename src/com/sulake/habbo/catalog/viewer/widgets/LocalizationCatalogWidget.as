package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class LocalizationCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function onClickLink(param1:WindowMouseEvent) : void
      {
         ...
         switch(page.layoutCode)
         {
               ...
               switch(_loc4_)
               {
                  ...
                  case "ctlg_txt7":
                     if(IWindow(param1.target).caption != "")
                     {
                        ...
                        {
                           if(false && "OutfitView" == _loc3_.getKey("client.credits.embed.enabled"))
                           {
            ...
            case "info_pixels":
               ...
               {
                  case "ctlg_text_5":
                     page.viewer.catalog.openInventoryCategory(InventoryCategory.const_367);
                     break;
                  case "ctlg_text_7":
      ...
      private function openExternalLink(param1:String) : void
      {
         ...
         if(param1 != "")
         {
            page.viewer.catalog.windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.method_5);
      ...
      private function retrieveCatalogImage(param1:String) : void
      {
         ...
         var _loc5_:String = this.var_873[param1];
