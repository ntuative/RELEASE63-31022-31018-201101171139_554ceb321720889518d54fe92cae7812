package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1176:PrizeViewer;
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         this.var_1176 = new PrizeViewer();
         this.var_768 = this.recycler.getPrizeTable();
         ...
         if(this.var_768.length > 0 && this.var_768[0].prizes.length > 0)
         {
            this.select(this.var_768[0].prizes[0] as IGridItem);
         }
      }
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            this.createLevelItem(this.var_768[_loc2_]);
            _loc2_++;
         }
      }
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         this.var_1176.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
