package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1920:int = 40;
      
      private const const_1919:int = 10;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_475)
         {
            this.var_475.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_475 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_711 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_711 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_711));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         this.updateStatusDisplay(this.const_1636,_loc2_.length);
         if(!this.var_475)
         {
            this.var_475 = new Timer(25);
            this.var_475.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1092 = 0;
         this.populateList();
         this.var_475.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1092 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1092));
            ++this.var_1092;
            _loc1_++;
         }
         return false;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1635);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_711.length)
         {
            _loc4_ = this.var_711[_loc6_.selection];
         }
         ...
         else if(param1.type == WindowEvent.const_108)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_1919;
                  break;
               case "search_input":
                  _loc8_ = this.const_1920;
                  break;
               default:
                  return;
            }
