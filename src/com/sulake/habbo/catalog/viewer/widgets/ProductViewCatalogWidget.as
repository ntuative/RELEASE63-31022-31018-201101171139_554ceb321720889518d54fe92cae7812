package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1225:IScrollbarWindow;
      ...
      {
         this.var_790 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_978 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_79 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1477 = new Point(this.var_79.x,this.var_79.y);
         this.var_435 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1225 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1478 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_790.text = _loc4_;
         this.var_978.text = _loc5_;
         this.var_790.height = this.var_790.textHeight + 5;
         this.var_978.y = this.var_790.y + this.var_790.height;
         this.var_978.height = Math.max(130,this.var_978.textHeight + 5);
               ...
               case Offer.const_547:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_255:
                        ...
                        _loc6_ = new BitmapData(this.var_79.width,this.var_79.height,false,_loc13_);
                        _loc14_ = null;
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_302,AvatarAction.const_455);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_79);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_1987)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_79 != null && true)
         {
            ...
            if(this.var_79.bitmap == null)
            {
               this.var_79.bitmap = new BitmapData(this.var_79.width,this.var_79.height,true,16777215);
            }
            this.var_79.bitmap.fillRect(this.var_79.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_79.width - param1.width) / 2,(this.var_79.height - param1.height) / 2);
            this.var_79.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_79.invalidate();
            this.var_79.x = this.var_1477.x;
            this.var_79.y = this.var_1477.y;
            if(param3 != null)
            {
               this.var_79.x += param3.x;
               this.var_79.y += param3.y;
            }
         }
         if(param2)
         {
