package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_2729:ITextWindow;
      ...
      override public function init() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_2361 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            this.var_2359 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            this.var_2362 = _loc3_.content as XML;
         }
         var _loc4_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsOrCreditsAndPixelsStub") as XmlAsset;
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,this.onSelectProduct);
         events.addEventListener(WidgetEvent.const_1041,this.onSetParameter);
      ...
      private function attachStub(param1:String) : void
      {
         ...
         switch(param1)
         {
            case Offer.const_798:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2361) as IWindowContainer;
               break;
            case Offer.const_961:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2359) as IWindowContainer;
               break;
            case Offer.const_1157:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2362) as IWindowContainer;
               break;
            default:
         ...
         this.var_1674 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         this.var_1676 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         this.var_1675 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
         this.var_2729 = _window.findChildByName("ctlg_special_txt") as ITextWindow;
         this.var_570 = window.findChildByName("ctlg_buy_button") as IButtonWindow;
         if(this.var_570 != null)
         {
            if(this.var_1332 != null)
            {
               this.var_570.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1332);
            }
            else
            {
               this.var_570.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1332);
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_1674 != null)
         {
            ...
            this.var_1674.caption = "${catalog.purchase.price.credits}";
         }
         var _loc3_:String = this.var_87.activityPointType == Purse.const_539 ? "pixels" : "activitypoints";
         ...
         if(this.var_1675 != null)
         {
            ...
            this.var_1675.caption = _loc2_.getKey(_loc4_);
         }
      ...
      {
         this.var_2360 = param1.parameter;
      }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         if(this.var_87 != null)
         {
            ...
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_87,page.pageId,this.var_2360);
         }
      }
   }
}
