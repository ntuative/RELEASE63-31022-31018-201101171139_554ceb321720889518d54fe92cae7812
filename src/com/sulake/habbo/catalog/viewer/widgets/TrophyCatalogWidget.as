package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : void
      {
         ...
         var _loc7_:* = null;
         super.init();
         this.var_79 = window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(this.var_248.getValue(_loc5_) == null)
            {
               this.var_248.add(_loc5_,new Map());
            }
            _loc7_ = this.var_248.getValue(_loc5_) as Map;
            _loc7_.add(_loc6_,_loc3_);
         }
         _loc4_ = this.var_248.getWithIndex(this.var_289);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_732);
            if(_loc3_ == null)
            {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_248.getWithIndex(this.var_289);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_732);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_289;
         if(this.var_289 >= this.var_248.length)
         {
            this.var_289 = 0;
         }
         var _loc2_:Map = this.var_248.getWithIndex(this.var_289);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_289 < 0)
         {
            this.var_289 = this.var_248.length - 1;
         }
         var _loc2_:Map = this.var_248.getWithIndex(this.var_289);
         if(_loc2_ != null)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(this.var_79 != null)
         {
            ...
            _loc3_ = new Point((this.var_79.width - param1.width) / 2,(this.var_79.height - param1.height) / 2);
            this.var_79.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
