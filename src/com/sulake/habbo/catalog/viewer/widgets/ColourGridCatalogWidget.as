package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         this.var_1769 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_1377.length,this._colourGrid.numGridItems]);
         this._colourGrid.destroyGridItems();
         this.var_335 = null;
         for each(_loc1_ in this.var_1377)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_1769) as IWindowContainer;
            ...
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_1057.width,this.var_1057.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_842.width,this.var_842.height,true,16777215);
               _loc5_.bitmap.copyPixels(this.var_842,this.var_842.rect,new Point(0,0),null,null,true);
