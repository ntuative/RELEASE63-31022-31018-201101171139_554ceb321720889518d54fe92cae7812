package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1911:int = 10;
      ...
      private const const_1640:uint = 4.293848814E9;
      
      private const const_1641:uint = 4.294967295E9;
      
      private const const_1910:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1598 = _loc1_.stuffTypes;
            this.var_680 = _loc1_.boxTypes;
            this.var_681 = _loc1_.ribbonTypes;
            this.var_1044 = this.var_1598[0];
            this.var_320 = this.var_680[0];
            this.var_319 = this.var_681[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_319 < 0)
         {
            this.var_319 = this.var_681.length - 1;
         }
         if(this.var_319 > this.var_681.length - 1)
         {
            this.var_319 = 0;
         }
         if(this.var_320 < 0)
         {
            this.var_320 = this.var_680.length - 1;
         }
         if(this.var_320 > this.var_680.length - 1)
         {
            this.var_320 = 0;
         }
         var _loc1_:int = this.var_680[this.var_320] * 1000 + this.var_681[this.var_319];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_87.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1044,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1277 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1598;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1044);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_680[this.var_320]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_681[this.var_319]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_87,this.var_1276,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_87.offerId,this.var_1276);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_108:
               ...
               if(this.var_2198 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_213)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1911)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2198 = _loc3_.text;
               break;
            case WindowMouseEvent.const_42:
               ...
               break;
            case WindowKeyboardEvent.const_383:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_318 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_318 + 1);
                     break;
      ...
      {
         if(this.var_232 == null || !this.var_232.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_232.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_318) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_232 == null)
         {
            this.var_232 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_557 == null)
         {
         ...
         if(this.var_232 == null || this.var_557 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_232.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_318) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_318);
         }
         this.var_318 = param1;
         if(this.var_318 < 0)
         {
            this.var_318 = _loc2_.numListItems - 1;
         }
         if(this.var_318 >= _loc2_.numListItems)
         {
            this.var_318 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_318) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1910;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1640) : uint(this.const_1641);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_232.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1044;
               }
            }
            _loc4_++;
         }
