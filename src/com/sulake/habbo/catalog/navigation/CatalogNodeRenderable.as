package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1277:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1375:XML;
      
      private static var var_1374:XML;
       
      
      private var var_1768:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1375 == null)
         {
            ...
            var_1375 = _loc4_.content as XML;
         }
         if(var_1374 == null)
         {
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1768 == 4294967295)
            {
               this.var_1768 = _loc1_.color;
            }
            _loc1_.color = const_1277;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1341;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1451;
            }
         }
      }
      ...
      {
         this.var_54 = navigator.catalog.windowManager.buildFromXML(var_1374) as IItemListWindow;
         if(this.var_54 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1375) as IWindowContainer;
         }
         else
         {
