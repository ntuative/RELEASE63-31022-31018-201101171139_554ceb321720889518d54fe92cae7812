package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_311:ICatalogNavigator;
      ...
      private var var_2137:GiftWrappingConfiguration;
      
      private var var_1034:ClubGiftController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         if(param1 is Offer)
         {
            ...
            this.var_199.showOffer(this,param1,param2,param3,_loc4_);
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_311.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         return this.var_367.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_367.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_79)
         {
            _loc3_ = this.var_367.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_104.getActivityPointsForType(Purse.const_539)));
         var _loc1_:int = 0;
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_724)
         {
            if(!this.var_367.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_311 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_83:
               this.var_1574 = param1.session.isPrivateRoom;
               if(this.var_88 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1034 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_311.buildCatalogIndex(_loc2_);
         if(this.var_669 && this.var_669 != "")
         {
            this.var_311.openPage(this.var_669);
            this.var_669 = "";
            this.var_821 = -1;
         }
         else if(this.var_821 > -1)
         {
            this.var_311.openPageById(this.var_821,this.var_1575);
            this.var_821 = -1;
            this.var_1575 = -1;
            this.var_669 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2139 && this.var_545 != null)
         {
            this.var_545.playSound(HabboSoundTypesEnum.const_1166);
         }
         this.var_2139 = false;
         if(this.var_275 != null)
         {
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2138 && this.var_545 != null)
         {
            this.var_545.playSound(HabboSoundTypesEnum.const_1149);
         }
         this.var_2138 = false;
         if(this.var_275 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1034.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2137 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "OutfitView" == this.var_170.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_170.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.method_5);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_177)
         {
            _loc3_ = this.var_170.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.method_5);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
