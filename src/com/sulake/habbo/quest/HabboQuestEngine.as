package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine
   {
      ...
      {
         this._catalog.openCatalogPage(CatalogPageName.const_1481,true);
      }
      ...
      private function onQuestsToolBarIconClick() : void
      {
         ...
         {
            _loc2_ = this.var_170.getKey("questing.supportMultipleCampaigns","");
            if(_loc2_ && _loc2_ == "OutfitView")
            {
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_170.getKey("image.library.questing.url");
