package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_432:Quest;
      
      private var var_268:QuestView;
      ...
      private var var_267:IItemListWindow;
      ...
      public function QuestCampaign(param1:QuestController, param2:String)
      {
         ...
         this.var_160 = new QuestHelp(this);
      }
      ...
      private function reset() : void
      {
         ...
         if(this.var_301)
         {
            ...
            {
               this.var_267.removeListItem(_loc1_.view);
               _loc1_.dispose();
            }
            this.var_301 = null;
            this.var_267.destroyListItems();
            this.var_267.removeListItems();
         }
         this.var_432 = null;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_969 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1219 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_267 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.code + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1219.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1219.findChildByName("currency.amount").caption = "${quest_" + this.var_1468 + ".currency}";
         var _loc3_:String = "quest_" + this.code;
         var _loc4_:* = _loc3_ + ".title";
         var _loc5_:* = _loc3_ + ".currency";
         this.setText("currency.amount",_loc5_);
         this.var_970 = this._window.findChildByName("help.button") as IWindowContainer;
         if(this.var_970)
         {
            this.var_970.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_970.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_970.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_432)
         {
            this.var_432.selected = false;
         }
         if(this.var_160)
         {
            this.var_969.addChild(this.var_160.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1560);
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1219.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_301.push(new Quest(_loc2_,this));
         }
         _loc3_ = null;
         for each(_loc4_ in this.var_301)
         {
            this.var_267.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_40 || _loc4_.status == QuestStatusEnum.const_517))
            {
               _loc3_ = _loc4_;
            }
         }
         if(_loc3_)
         {
            ...
            if(this.var_267.maxScrollV > 0)
            {
               this.var_267.scrollV = _loc3_.view.y / this.var_267.maxScrollV;
            }
         }
         else if(this.var_301.length > 0)
         {
            this.activateListItem(this.var_301[0]);
         }
      }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_432 = param1;
         this.var_432.selected = true;
         this.showQuestData(this.var_432);
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_268 = new QuestView(this,param1);
         this.var_969.addChild(this.var_268.view);
         this.var_268.init();
      }
      ...
      {
         this.modifyQuestData(param1);
         this.var_639.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         for each(_loc3_ in this.var_639)
         {
            if(_loc3_ == param1)
            {
               _loc2_ = _loc3_;
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_639.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
               this.var_639.splice(_loc4_,1);
            }
         }
      }
      ...
      private function modifyQuestData(param1:QuestMessageData) : void
      {
         ...
         if(_loc2_)
         {
            ...
            this.var_301[_loc3_] = _loc5_;
            _loc6_ = this.var_267.getListItemIndex(_loc2_.view);
            this.var_267.removeListItem(_loc2_.view);
            if(_loc6_ > -1)
            {
               this.var_267.addListItemAt(_loc5_.view,_loc6_);
            }
            else
            {
               this.var_267.addListItem(_loc5_.view);
            }
