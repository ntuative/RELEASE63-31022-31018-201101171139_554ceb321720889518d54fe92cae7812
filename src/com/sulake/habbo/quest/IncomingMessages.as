   ...
   public class IncomingMessages
   {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(this.var_157.toolbar != null && this.var_157.configuration != null)
         {
            ...
            if(_loc3_ && _loc3_ != "" || _loc2_ && _loc2_ == "OutfitView")
            {
               this.var_157.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
      ...
      private function onRoomExit(param1:IMessageEvent) : void
      {
         ...
         this.var_157.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_157,HabboToolbarIconEnum.QUESTS));
      }
