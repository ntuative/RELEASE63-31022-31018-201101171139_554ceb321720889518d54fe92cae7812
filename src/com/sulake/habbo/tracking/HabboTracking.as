package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_913:uint = 11;
      ...
      private var var_605:FramerateTracker = null;
      
      private var var_255:LatencyTracker = null;
      
      private var var_603:LagWarningLogger = null;
      
      private var var_604:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_605 = new FramerateTracker();
         this.var_255 = new LatencyTracker();
         this.var_603 = new LagWarningLogger();
         this.var_604 = new ToolbarClickTracker(this);
         this.var_1411 = new Array(const_913);
         var _loc4_:int = 0;
         while(_loc4_ < const_913)
         {
            this.var_1411[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1561,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1466,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_737,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1067,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_189)
            {
               if(!this.var_189.disposed)
               {
                  Component(this.var_189).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_189).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_189).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_189).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_189).events.removeEventListener(HabboFriendListTrackingEvent.const_328,this.onFriendlistTrackingEvent);
               }
               this.var_189.release(new IIDHabboFriendList());
               this.var_189 = null;
            }
            if(this.var_160)
            {
               if(!this.var_160.disposed)
               {
                  this.var_160.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_160.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_160.release(new IIDHabboHelp());
               this.var_160 = null;
            }
            if(this._toolbar)
            {
      ...
      {
         this.var_1411[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_170 = IHabboConfigurationManager(param2);
         if(this.var_170)
         {
            if(this.var_255 != null)
            {
               this.var_255.configuration = this.var_170;
            }
            if(this.var_254 != null)
            {
               this.var_254.configuration = this.var_170;
            }
            ...
            if(this.var_170)
            {
               ...
               {
                  this.var_603.configure(this.var_170);
               }
               if(this.var_605 != null)
               {
                  this.var_605.configure(this.var_170);
               }
               if(this.var_604 != null)
               {
                  this.var_604.configure(this.var_170);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_674,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_687,this.onHotelViewEvent);
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1336);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1436);
               break;
            case HabboCommunicationEvent.const_674:
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_170)
            {
               if(this.var_170.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_170.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1411)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1057);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1057,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_189 = param2 as IHabboFriendList;
         Component(this.var_189).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_189).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_189).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_189).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_189).events.addEventListener(HabboFriendListTrackingEvent.const_328,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_160 = param2 as IHabboHelp;
         this.var_160.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_160.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1067,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_737,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_270.events.addEventListener(AdEvent.const_505,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_604)
         {
            this.var_604.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_170 != null && !Boolean(this.var_170.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1818;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1818);
         }
         if(this.var_500 > -1 && _loc2_ - this.var_500 > 15000)
         {
            ++this.var_1817;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1817);
         }
         this.var_500 = _loc2_;
         if(this.var_254 != null)
         {
         ...
         if(this.var_255 != null)
         {
            this.var_255.update(param1,this.var_500);
         }
         if(this.var_605 != null)
         {
            this.var_605.trackUpdate(param1,this,this.var_500);
         }
         if(this.var_603 != null)
         {
            this.var_603.update(this.var_500);
         }
      }
   }
}
