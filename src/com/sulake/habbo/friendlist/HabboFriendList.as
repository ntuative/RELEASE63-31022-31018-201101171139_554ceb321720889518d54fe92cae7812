package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_568.stop();
            this.var_568.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_568 = null;
         }
         ...
         if(this.var_1089)
         {
            this.var_1089.release(new IIDAvatarRenderManager());
            this.var_1089 = null;
         }
         if(this.var_904)
         {
            this.var_904.release(new IIDHabboNotifications());
            this.var_904 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_707)
         {
            this.var_707.release(new IIDSessionDataManager());
            this.var_707 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1667 = new OpenedToWebPopup(this);
         }
         this.var_1667.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_330.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_264,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1089.createAvatarImage(param1,AvatarScaleType.const_81,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_170.getKey("client.minimail.embed.enabled");
         return _loc1_ == "OutfitView";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_170.getKey(param1,param1,param2);
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1089 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_904 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_330 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_92.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_92.addCategory(new FriendCategory(FriendCategory.const_1165,this.getText("friendlist.friends")));
         this.var_92.addCategory(new FriendCategory(FriendCategory.const_382,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_92.addFriend(new Friend(_loc4_));
         }
         this.var_407 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_568)
         {
            this.var_568 = new Timer(120000);
            this.var_568.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_568.start();
         }
         ...
         {
            _loc5_ = this.var_92.findCategory(FriendCategory.const_382);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_407.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_330.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_330.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_407.findTab(FriendListTab.const_92).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_330.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_407.findTab(FriendListTab.const_92);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1666.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_407.findTab(FriendListTab.const_92);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_707 || !this.var_330)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_707.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_330.vipLimit;
         }
         else if(this.var_707.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_330.clubLimit;
         }
         if(_loc2_ > this.var_330.limit)
         {
            this.var_330.limit = _loc2_;
         }
      }
