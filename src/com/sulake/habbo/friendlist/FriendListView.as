package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1633:String = "noconvinfo";
      
      private static const const_1634:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1299:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1299 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_852 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_233 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1299.prepare(this.var_852);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_944,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1103,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_816,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_736,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_816,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_736,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1300 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1300.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1627 == -1 ? 0 : int(this.var_16.height - this.var_1627);
         var _loc4_:int = this.var_1625 == -1 ? 0 : int(this.var_16.width - this.var_1625);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_233.y = Util.getLowestPoint(this.var_16.content);
         this.var_233.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1119,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_816,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_944,false);
         ...
         this.var_1627 = this.var_16.height;
         this.var_1625 = this.var_16.width;
