package com.sulake.habbo.friendlist
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindowContainer, param2:IWindow) : void
      {
         if(this.var_51 == null)
         {
            this.var_51 = IWindowContainer(this._friendList.getXmlWindow(this.var_960));
         ...
         this.var_51.x = _loc4_.x - _loc3_.x + this.var_2092 + param2.width;
