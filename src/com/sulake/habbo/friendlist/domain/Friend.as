package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1887:int = "F".charCodeAt(0);
      
      public static const const_1830:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_932 = param1.gender;
         this.var_708 = param1.online;
         this.var_1520 = param1.followingAllowed && param1.online;
         this.var_609 = param1.figure;
         this.var_1521 = param1.motto;
         this.var_1519 = param1.lastAccess;
         this.var_1417 = param1.categoryId;
         this.var_1522 = param1.realName;
