package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_369:int = 100;
      ...
      {
         var _loc4_:* = null;
         if(this.var_213.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         {
            _loc4_ = this.var_213[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               this.var_213.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean = false) : int
      {
         var _loc4_:* = null;
         var _loc3_:int = 0;
         for each(_loc4_ in this.var_213)
         {
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_213,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         if(this.var_920 >= this.getPageCount())
         {
            this.var_920 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_213.length / const_369);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_920 * const_369;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_920 + 1) * const_369,this.var_213.length);
      }
