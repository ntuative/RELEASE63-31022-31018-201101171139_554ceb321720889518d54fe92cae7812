package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1916:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_17 != null)
         {
            this.var_17.events.removeEventListener(RoomSessionEvent.const_83,this.roomSessionEventHandler);
            this.var_17.events.removeEventListener(RoomSessionEvent.const_89,this.roomSessionEventHandler);
            this.var_17.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_457,this.roomSessionEventHandler);
      ...
      {
         return TradingModel(this.var_46.getValue(InventorySubCategory.const_292));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_46.getValue(InventoryCategory.const_828));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_46.getValue(InventoryCategory.const_276));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_46.getValue(InventoryCategory.const_367));
      }
      ...
      {
         return PetsModel(this.var_46.getValue(InventoryCategory.const_155));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_46.getValue(InventoryCategory.const_321) as MarketplaceModel;
      }
      ...
      {
         this.var_367 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_17.events.addEventListener(RoomSessionEvent.const_83,this.roomSessionEventHandler);
         this.var_17.events.addEventListener(RoomSessionEvent.const_89,this.roomSessionEventHandler);
         this.var_17.events.addEventListener(RoomSessionPropertyUpdateEvent.const_457,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_367 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_17 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_46.add(InventoryCategory.const_321,_loc1_);
         ...
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_367);
         this.var_46.add(InventoryCategory.const_276,_loc3_);
         ...
         this.var_46.add(InventoryCategory.const_828,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_367);
         this.var_46.add(InventoryCategory.const_367,_loc5_);
         ...
         this.var_46.add(InventorySubCategory.const_292,_loc6_);
         ...
         this.var_46.add(InventoryCategory.const_155,_loc8_);
         this.var_176 = true;
         if(this.var_2339)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_865.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_865.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_865.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1916);
         }
      }
