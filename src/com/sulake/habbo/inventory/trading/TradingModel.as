package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1500:uint = 9;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_50.updateItemList(this.var_684);
         this.var_50.updateItemList(this.var_1281);
      ...
      public function close() : void
      {
         if(this.var_693)
         {
            if(this._state != const_183 && this._state != const_203)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_683 + " OTHER: " + this.var_1049);
         ...
         {
            case const_183:
               if(param1 == const_187 || param1 == const_203)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_50.alertPopup(TradingView.const_1024);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_1049 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_50.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_50.alertPopup(TradingView.const_991);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_278.length < const_1500)
         {
