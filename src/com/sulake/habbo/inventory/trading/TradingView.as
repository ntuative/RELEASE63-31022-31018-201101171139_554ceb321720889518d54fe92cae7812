package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_401:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_401 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_188)
            {
               this.var_188.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_188.stop();
               this.var_188 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1745 = this.createMinimizedWindow();
         }
         if(!this.var_2467)
         {
            return this.var_65;
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_188 = new Timer(1000,3);
            this.var_188.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_188.reset();
         this.var_188.repeatCount = 3;
         this.var_188.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_188.currentCount));
         if(this.var_188.currentCount == 3)
         {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_969)
            {
            ...
            this.var_401.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_427);
            this.var_401.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_401.hideDelayed();
         }
      }
