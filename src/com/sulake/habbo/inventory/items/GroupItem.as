package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_636:BitmapData;
      
      protected var var_2468:int;
      
      protected var var_1461:Boolean;
      
      protected var var_1944:Boolean;
      
      protected var var_2696:BitmapData;
      
      private const const_1915:int = 8947848;
      
      private const const_1914:int = 13421772;
      
      private const const_1632:Number = 1;
      
      private const const_1631:Number = 0.2;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1324));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1938);
         }
         if(_loc1_.id > 0)
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_697)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1631;
               _loc1_.blend = this.const_1631;
            }
            else
            {
               this._window.blend = this.const_1632;
               _loc1_.blend = this.const_1632;
            }
         }
         if(this.isSelected)
         {
            this._window.color = this.const_1915;
         }
         else
         {
            this._window.color = this.const_1914;
         }
         ...
         if(_loc5_)
         {
            if(this.var_1944 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2696;
               _loc5_.visible = true;
            }
            else
            {
