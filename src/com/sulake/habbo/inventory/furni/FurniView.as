package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1943:int = 0;
      
      private const const_871:int = 1;
      
      private const const_1623:int = 2;
      
      private const const_1624:int = 3;
      
      private const const_1622:int = 42;
      
      private const const_1621:int = 120;
      ...
      private var var_650:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_458.add(FurniModel.const_41,new FurniGridView(this.var_62,FurniModel.const_41,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_458.add(FurniModel.const_46,new FurniGridView(this.var_62,FurniModel.const_46,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_458.getValue(this.var_380);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_62.getCategoryContent(this.var_380);
         if(!this.var_62.isListInited())
         {
            _loc2_ = this.const_871;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1623;
         }
         else
         {
            _loc2_ = this.const_1624;
         }
         if(this.var_2165 == _loc2_)
         {
            return;
         }
         ...
         switch(_loc2_)
         {
            case this.const_871:
               ...
               break;
            case this.const_1623:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1624:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_41,FurniModel.const_46];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_458.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_458.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_458.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_62.getGroupItemInIndex(_loc3_,this.var_380);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_650 && this.var_650.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1621)
         {
            _loc3_ = this.const_1621;
         }
         else if(_loc3_ < this.const_1622)
         {
            _loc3_ = this.const_1622;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_55)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_368);
            }
         }
      }
   }
