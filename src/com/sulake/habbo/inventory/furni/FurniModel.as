package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_368:String = "pets";
      
      private static const const_1240:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this.var_578 = new Timer(const_1240,1);
         ...
         this.var_2446 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_889 == null)
         {
            this.var_889 = this._windowManager.buildFromXML(this.var_2446) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_889.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_41,const_46];
         var _loc5_:int = 0;
      ...
      public function updateLocks() : void
      {
         ...
         var _loc7_:Array = [const_41,const_46];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_41,const_46];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_484.add(const_41,new Array());
         this.var_484.add(const_46,new Array());
         if(this._view != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_337 || _loc3_.category == FurniCategory.const_350 || _loc3_.category == FurniCategory.const_331)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1351 && param1.type == RoomEngineObjectEvent.const_246)
         {
            this.var_1351 = false;
         }
      }
      ...
      {
         return this.var_484.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_484.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_484.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_697)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
