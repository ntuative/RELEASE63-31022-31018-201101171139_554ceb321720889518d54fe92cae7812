package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_89 = this.var_628.height;
         this.var_1182 = param5;
         this.var_948 = param6;
         this.var_219 = Math.floor(this.var_1182 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1182,this.var_948);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_629 = this.resolveRowCountFromList();
         if(this.var_629 == 0)
         {
            this.var_26 = new BitmapData(this.var_1182,this.var_948);
            return;
         }
         this.var_26 = new BitmapData(Math.max(this.var_219 * this._thumbWidth,this.var_1182),Math.max(this.var_629 * this.var_89,this.var_948),true,16777215);
         this.var_26.fillRect(this.var_26.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_629)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_219 && this.var_26.height < _loc3_.y * this.var_89)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_219 - 1),this.var_89);
         ...
         _loc4_ = new Rectangle(0,this.var_89,this._thumbWidth * (this.var_219 - 1),this.var_26.height - this.var_89);
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_26.height < this.var_948)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_948);
