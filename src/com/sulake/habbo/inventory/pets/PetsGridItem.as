package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_42:
               this.var_1410.setSelectedGridItem(this);
               this.var_1409 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1409 = false;
                  this.var_1410.placePetToRoom(this.var_1333.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this._window.color = !!this._isSelected ? uint(this.const_1915) : uint(this.const_1914);
      }
