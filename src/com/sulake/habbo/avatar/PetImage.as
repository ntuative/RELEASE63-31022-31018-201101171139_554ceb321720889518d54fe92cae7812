package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_609 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_609.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1397 = this.var_1396;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_45)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1397);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_575);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_609,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1397 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_575);
                  _loc20_ = this.var_84;
                  _loc21_ = 1;
                  switch(this.var_84)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_575);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_609,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_81)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_575);
                  _loc21_ = this.var_84;
                  _loc22_ = 1;
                  switch(this.var_84)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_480 = this.var_480 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_384:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1498:
                  case AvatarAction.const_1128:
                  case AvatarAction.const_982:
                  case AvatarAction.const_1558:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_298.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_922);
         this.getCache().resetBodyPartCache(this.var_922);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1398 = this._structure.sortActions(this.var_298);
         ...
         {
            this.var_692 = this._structure.getCanvasOffsets(this.var_1398,this._scale,this.var_84);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1398)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_222)
               {
                  this.var_923 = true;
               }
