package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2244 = parseInt(param1.@precedence);
         this.var_2242 = String(param1.@activepartset);
         this.var_2245 = String(param1.@assetpartdefinition);
         this.var_2239 = String(param1.@lay);
         this.var_687 = String(param1.@geometrytype);
         this.var_2246 = Boolean(parseInt(param1.@main));
         this.var_2241 = Boolean(parseInt(param1.@const_35));
         this.var_2240 = Boolean(parseInt(param1.@animation));
         this._preventHeadTurn = Boolean(String(param1.@preventheadturn == "OutfitView"));
