package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_841:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1057.width,this.var_1057.height,true,0);
            _loc5_ = this.var_1057.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_841.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_842.width,this.var_842.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_842,this.var_842.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
