   ...
   public class AvatarEditorGridView
   {
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(this._view != null)
         {
            ...
            this.var_502.push(this._view.findChildByName("palette0") as IItemGridWindow);
            this.var_502.push(this._view.findChildByName("palette1") as IItemGridWindow);
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = this.var_62.getCategoryData(this.var_1417);
         if(!_loc1_)
         {
            return;
         }
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_42)
         {
            ...
            this.var_62.selectPart(this.var_1417,_loc3_);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.const_42)
         {
            ...
            while(_loc7_ < this.const_1169)
            {
               if(this.var_502.length > _loc7_)
               {
                  ...
                  if(_loc5_ > -1)
                  {
                     this.var_62.selectColor(this.var_1417,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;
