   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_35)
         {
            ...
            var_35["null"] = new AvatarEditorGridView(var_62,FigureData.const_219,_windowManager,_assetLibrary);
            var_35["null"] = new AvatarEditorGridView(var_62,FigureData.const_181,_windowManager,_assetLibrary);
            var_35["null"] = new AvatarEditorGridView(var_62,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_35["null"] = new AvatarEditorGridView(var_62,FigureData.const_228,_windowManager,_assetLibrary);
         }
         else
         {
