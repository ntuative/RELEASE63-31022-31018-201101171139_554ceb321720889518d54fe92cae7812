package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1895:String = "hd-99999-99999";
      ...
      private var var_303:PetDataManager;
      
      private var var_641:PaletteManager;
      
      private var var_538:String;
      
      private var var_271:Map;
      
      private var var_194:AvatarAssetDownloadManager;
      
      private var var_1479:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_538 = RenderMode.const_1429;
         ...
         this.var_93.add(AvatarType.const_111,_loc4_);
         ...
         this.var_303 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_641 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_303.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_194)
         {
            this.var_194.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_303.init();
         this.var_641.init();
         _loc2_ = this.var_93.getValue(AvatarType.const_111) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_93.getValue(AvatarType.const_111) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_170.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_194 == null)
               {
                  ...
                  _loc6_ = this.var_170.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_170.getKey("flash.dynamic.avatar.download.url","");
                  this.var_194 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_194.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_885)
         {
            if(this.var_1988 && this.var_1990 && this.var_1989)
            {
      ...
      public function isFigureReady(param1:AvatarFigureContainer) : Boolean
      {
         ...
         return this.var_194.isReady(param1);
      }
      ...
      public function downloadFigure(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_194.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_93.getValue(AvatarType.const_111) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_194.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1479)
         {
            this.var_1479 = new AvatarFigureContainer(this.const_1895);
         }
         this.var_194.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1479,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_271 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_271.getKeys())
         {
            _loc4_ = this.var_271.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1536)
         {
            _loc6_ = !this.var_303.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_303.createPetFigureString(param1,param2,param3);
         ...
         if(param5 != null)
         {
            ...
            this.var_271.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_303.populateFigureData(_loc1_);
         ...
         {
            _loc4_ = this.var_271.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_93.getValue(AvatarType.const_111) as AvatarStructure;
      ...
      {
         return this.var_303 as IPetDataManager;
      }
