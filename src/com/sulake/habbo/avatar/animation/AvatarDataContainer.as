package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1717:Number = 1.0;
      
      private var var_1716:Number = 1.0;
      ...
      {
         super();
         this.var_1686 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2385 = parseInt(_loc2_,16);
         this.var_2383 = parseInt(_loc3_,16);
         ...
         this.var_1833 = new ColorTransform(this.var_1715,this.var_1717,this.var_1716,this._alphaMultiplier);
         this.var_1096 = this.generatePaletteMapForGrayscale(this.var_2383,this.var_2385);
      }
      ...
      {
         return this.var_1096.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1096.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1096.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1096.getValue("alphas") as Array;
      }
