package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1170:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1171:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_707:ISessionDataManager;
      
      private var _view:AvatarEditorView;
      
      private var var_975:AvatarEditorHandler;
      ...
      private var var_789:IFigureData;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_176)
         {
            ...
            this.var_528["null"] = new FigureData(this);
            this.var_528["null"] = new FigureData(this);
            _loc2_ = this.var_528["null"];
            _loc3_ = this.var_528["null"];
            _loc2_.loadAvatarData(const_1170,FigureData.const_75);
            _loc3_.loadAvatarData(const_1171,FigureData.FEMALE);
            this.var_92 = new Map();
            this.var_434 = new Map();
            this.var_92.add(AvatarEditorFigureCategory.const_735,new BodyModel(this));
            this.var_92.add(AvatarEditorFigureCategory.const_45,new HeadModel(this));
            this.var_92.add(AvatarEditorFigureCategory.const_220,new TorsoModel(this));
            this.var_92.add(AvatarEditorFigureCategory.const_641,new LegsModel(this));
            if(param1 == null || param1.indexOf(AvatarEditorFigureCategory.HOTLOOKS) > -1)
            {
               this.var_92.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
            }
            this.var_434.add(AvatarEditorSideCategory.const_97,new WardrobeModel(this));
            this.var_434.add(AvatarEditorSideCategory.const_482,new ClubPromoModel(this));
            this.var_176 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         this.var_976 = param3;
         var _loc4_:FigureData = this.var_528[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_789.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_789.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this._windowContext == null)
            {
               this._windowContext = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_54,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_735);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_434.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_707 = param2 as ISessionDataManager;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_433 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_789 = this.var_433.getFigureData(AvatarType.const_111);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_975 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_528[this.var_932];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1224 != null)
         {
            ...
            this.var_1224.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_976 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1169)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1455.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_433.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_433.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1191.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1520)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_976 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1191.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_976 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_434.getValue(AvatarEditorSideCategory.const_97);
      }
