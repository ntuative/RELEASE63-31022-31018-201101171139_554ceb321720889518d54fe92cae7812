package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_609 && this.var_1419)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_81,this.var_932,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_32,parseInt(FigureData.const_768));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_609 = this._controller.figureData.getFigureString();
               this.var_932 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1834,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_609)
               {
                  this._controller.loadAvatarInEditor(this.var_609,this.var_932,this._controller.clubMemberLevel);
               }
         }
      }
