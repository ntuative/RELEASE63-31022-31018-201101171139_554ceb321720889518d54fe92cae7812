package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1191:IWindowContainer;
      
      public static var var_1455:IWindowContainer;
      
      public static var var_1931:int = 6710886;
      ...
      private var var_460:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1038 = [];
         this.var_1274 = [AvatarEditorFigureCategory.const_735,AvatarEditorFigureCategory.const_45,AvatarEditorFigureCategory.const_220,AvatarEditorFigureCategory.const_641,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_97];
         super();
         ...
         if(var_1191 == null)
         {
            ...
            var_1191 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1455 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1455 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_382 = new Timer(1000);
         this.var_382.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1274;
         }
         for each(_loc6_ in param4)
         {
            this.var_1038.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_382.stop();
            this.var_382.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_382 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1274);
         }
         if(param1.length != this.var_1038.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1038.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2187 = this.canChangeOutfit();
            this.var_382.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_460 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_460.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_460.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1038.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_460.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_460.numSelectables)
               {
                  this.var_460.getSelectableAt(_loc6_).x = this.var_460.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1274;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1594 == AvatarEditorSideCategory.const_97 || this.var_2186))
         {
      ...
      {
         if(this.var_1594 == AvatarEditorSideCategory.const_97)
         {
            this.var_2186 = false;
            this.setSideContent(AvatarEditorSideCategory.const_843);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_843:
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_316 = param1;
         this.var_460.setSelected(this.var_460.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_461)
         {
            ...
            this.var_461 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_461.procedure = this.stripClubDialogEventProc;
            this.var_461.center();
         }
         else
         {
            this.var_461.visible = true;
            this.var_461.center();
         }
      }
