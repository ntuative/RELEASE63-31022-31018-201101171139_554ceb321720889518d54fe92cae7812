package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1236:String = "Default";
      
      private static const const_1235:int = 2;
      
      private static const const_1237:String = AvatarSetType.const_32;
      ...
      protected var var_1956:int;
      
      protected var var_264:IActiveActionData;
      
      protected var var_727:Boolean;
      ...
      protected var var_609:AvatarFigureContainer;
      
      protected var var_521:IAvatarDataContainer;
      
      protected var var_298:Array;
      
      protected var var_42:BitmapData;
      
      private var var_922:IActiveActionData;
      ...
      private var var_2426:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1237,const_1235);
         this.var_298 = new Array();
         this.var_922 = new ActiveActionData(AvatarAction.const_322);
         this.var_922.definition = this._structure.getActionDefinition(const_1236);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_609,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1707;
         if(param2 < AvatarDirectionAngle.const_1114)
         {
            param2 = AvatarDirectionAngle.const_296 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_296)
         {
            param2 -= NaN;
         }
         ...
         if(param1 == AvatarSetType.const_45 || param1 == AvatarSetType.const_32)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_575,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_243.length == 1 && this.var_84 == this.var_1956)
         {
            return this.var_84 + this.var_480 + this.var_575 % 4;
         }
         if(this.var_243.length == 2)
         {
            for each(_loc1_ in this.var_243)
            {
               ...
               {
                  return this.var_84 + this.var_480 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_575 % 11;
                  return this.var_84 + "_" + this.var_1956 + this.var_480 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2425 || param2 != this.var_2424 || param1 != this.var_2426)
         {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_264.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1207 || this.var_42 == null || (this.var_42.width != _loc5_.width || this.var_42.height != _loc5_.height))
         {
            if(this.var_42 != null && !this.var_1207)
            {
               this.var_42.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_264.definition.geometryType,this.var_84);
         this.var_42.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_575);
         ...
         {
            if(this.var_521.paletteIsGrayscale)
            {
               ...
               this.var_42 = _loc13_;
               this.var_42.paletteMap(this.var_42,this.var_42.rect,new Point(0,0),this.var_521.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_264.definition.geometryType,this.var_84);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_575);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_298.length)
         {
            _loc3_ = this.var_298[_loc4_];
         ...
         this.var_298.push(new ActiveActionData(param1,param2,this.var_575));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_264 = this.var_922;
         this.var_264.definition = this.var_922.definition;
         this.resetBodyPartCache(this.var_922);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_480 = "";
         this.var_243 = this._structure.sortActions(this.var_298);
         if(this.var_243 == null)
         {
         ...
         {
            this.var_692 = this._structure.getCanvasOffsets(this.var_243,this._scale,this.var_84);
            for each(_loc4_ in this.var_243)
            {
               this.var_480 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_288)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1348 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1348 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1347 != this.var_480)
            {
               _loc1_ = true;
               this.var_1347 = this.var_480;
            }
         }
         this.var_1346 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_243)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_923 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_521 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_286 || _loc1_.actionType == AvatarAction.const_222 || _loc1_.actionType == AvatarAction.const_364)
               {
                  this.var_923 = true;
               }
            }
