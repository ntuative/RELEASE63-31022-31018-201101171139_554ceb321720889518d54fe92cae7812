package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_173 && this._navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      {
         if(this._navigator.configuration.getKey("roomenterad.habblet.enabled") == "OutfitView" && false)
         {
      ...
      private function onUserFlatCats(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:RoomsTabPageDecorator = RoomsTabPageDecorator(this._navigator.tabs.getTab(Tabs.const_245).tabPageDecorator);
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_.reason)
         {
            ...
            case CantConnectMessageParser.const_1484:
               ...
               _loc3_.show();
               break;
            case CantConnectMessageParser.const_1566:
