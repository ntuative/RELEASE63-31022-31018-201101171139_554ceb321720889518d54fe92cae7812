package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1766:Boolean = true;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_593 = new Timer(100);
         this.var_593.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         ...
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,80,"g"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,74,"h"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,416,"o"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,352,"p"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,304,"q"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,336,"r"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,748,"u"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_60,438,"v"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_51,540,"t"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_51,512,"w"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_51,396,"x"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_51,440,"y"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_51,456,"z"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_51,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_593)
         {
            this.var_593.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_593.reset();
            this.var_593 = null;
         }
      }
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!this.var_1766 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1766 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_54 = IItemListWindow(this.var_166.findChildByName("item_list"));
         ...
         var _loc3_:IWindow = this.var_166.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1136 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_166.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_166.desktop,this.var_166.width,this.var_166.height);
         this.var_166.x = _loc4_.x;
         this.var_166.y = _loc4_.y;
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_54,HabboWindowStyle.const_30,HabboWindowParam.const_57,new Rectangle(0,0,100,300)));
      }
