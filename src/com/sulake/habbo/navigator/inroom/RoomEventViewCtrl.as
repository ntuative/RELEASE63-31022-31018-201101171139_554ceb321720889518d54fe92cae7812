package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      {
         this.var_836.visible = false;
         this.var_1609.visible = true;
         this.var_2214.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_688.setText(param1.eventDescription);
         this.var_796.setText(this.getTagFromEvent(param1,1));
         this.var_797.setText(this.getTagFromEvent(param1,2));
         this.var_1286.visible = false;
         this.var_1285.visible = true;
         this.var_1284.visible = true;
         this.var_1608.visible = false;
         this.var_1610.visible = true;
      }
      ...
      private function createEvent() : void
      {
         ...
         this.var_796.goBackToInitialState();
         this.var_797.goBackToInitialState();
         this.var_836.selection = 0;
         this.var_1608.visible = true;
         this.var_1610.visible = false;
      }
      ...
      {
         var _loc1_:int = this.var_836.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.addTag(_loc6_,this.var_796.getText());
         this.addTag(_loc6_,this.var_797.getText());
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1609 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2214 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1608 = ITextWindow(this.find("create_caption"));
            this.var_1610 = ITextWindow(this.find("edit_caption"));
            this.var_1286 = IButtonWindow(this.find("create_button"));
            this.var_1285 = IButtonWindow(this.find("edit_button"));
            this.var_2213 = IButtonWindow(this.find("cancel_button"));
            this.var_1284 = IButtonWindow(this.find("end_button"));
            this.var_836 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1286,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1285,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1284,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2213,this.onCancelButtonClick);
            ...
            this.var_796 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_797 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
