package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailEditorModel
   {
      ...
      private var var_180:RoomThumbnailObjectData;
      ...
      private function removeSelected() : void
      {
         ...
         var _loc2_:int = Util.remove(_loc1_,this.var_180);
         this.var_180 = null;
         if(_loc1_.length > 0)
         {
            this.var_180 = _loc1_[Math.min(_loc2_,_loc1_.length - 1)];
         }
      }
      ...
      {
         this.var_180 = this.findByPos(param1);
         if(this.var_180 == null)
         {
      ...
      {
         if(this.var_538 == const_34)
         {
            this._data.bgImgId = param1;
         }
         else if(this.var_538 == const_56)
         {
            this._data.frontImgId = param1;
         }
         if(this.var_538 == const_33)
         {
            if(this.var_180 == null)
            {
               return;
            }
            this.var_180.imgId = param1;
         }
      }
      ...
      public function getImgId() : int
      {
         ...
         if(this.var_538 == const_56)
         {
            return this._data.frontImgId;
         }
         return this.var_180 == null ? -1 : int(this.var_180.imgId);
      }
      ...
      {
         this._data = param1;
         this.var_538 = const_34;
         if(this._data.objects.length > 0)
         {
            this.var_180 = this._data.objects[0];
         }
         else
         {
            this.var_180 = null;
