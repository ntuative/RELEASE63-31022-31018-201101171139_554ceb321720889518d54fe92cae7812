package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_891:int = 1;
      
      private static const const_569:int = 2;
      
      private static const const_890:int = 3;
      
      private static const const_1216:int = 4;
      ...
      private var var_830:PopularTagsListCtrl;
      
      private var var_831:GuestRoomListCtrl;
      
      private var var_1046:OfficialRoomListCtrl;
      ...
      private var var_1280:IWindow;
      
      private var var_1047:IRegionWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_830 = new PopularTagsListCtrl(this._navigator);
         this.var_831 = new GuestRoomListCtrl(this._navigator);
         this.var_1046 = new OfficialRoomListCtrl(this._navigator);
         this.var_465 = new Timer(300,1);
         this.var_465.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_465)
            {
               this.var_465.removeEventListener(TimerEvent.TIMER,this.onResizeTimer);
               this.var_465.reset();
               this.var_465 = null;
            }
            if(this.var_830)
      ...
      private function prepare() : void
      {
         ...
         this.var_233 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1280 = this.var_16.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_16.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1047 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(!this.var_1047)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1047.procedure = this.onHotelView;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_851,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1439,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_166,["custom_content","list_content"],this.var_203.y,8);
         this.var_182.height = this.var_182.height + _loc1_ - this.var_182.y - this.var_233.height + this.var_2201;
         Util.moveChildrenToColumn(this.var_166,["list_content","custom_footer"],this.var_182.y,0);
         this.var_2201 = this.var_233.height;
      ...
      private function refreshFooter() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshFooter(this.var_233);
         if(Util.hasVisibleChildren(this.var_233))
         {
      ...
      {
         this.refreshList(param1,param2,this.var_831,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_830,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1046,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_559 == const_891)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_182.blend - _loc2_));
            this.var_182.blend = _loc3_;
            this.var_203.blend = !!this.var_1048 ? Number(_loc3_) : Number(1);
            this.var_233.blend = !!this.var_1048 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_559 = const_569;
            }
         }
         else if(this.var_559 == const_569)
         {
            if(this.var_1279 % 10 == 1)
            {
               this.var_1280.visible = !this.var_1280.visible;
            }
            ++this.var_1279;
            if(!this._navigator.data.isLoading())
            {
               this.var_559 = const_890;
            }
         }
         else if(this.var_559 == const_890)
         {
            this.refresh();
            this.var_559 = const_1216;
         }
         else
         {
      ...
      {
         this.refreshScrollbar(this.var_830);
         this.refreshScrollbar(this.var_831);
      }
      ...
      {
         this._navigator.refreshButton(this.var_1047,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1047,"icon_hotelview_reactive",param1,null,0);
      }
