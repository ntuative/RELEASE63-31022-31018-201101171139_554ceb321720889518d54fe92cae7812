package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_606:RoomInfoViewCtrl;
      
      private var var_1156:RoomCreateViewCtrl;
      ...
      private var var_795:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_606 = new RoomInfoViewCtrl(this);
         this.var_1156 = new RoomCreateViewCtrl(this);
         this.var_2044 = new RoomThumbnailRenderer(this);
         this.var_795 = new GuestRoomPasswordInput(this);
         this.var_341 = new GuestRoomDoorbell(this);
         this.var_407 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_264,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_606.registerToolbarEvents();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_170.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_293.startSearch(Tabs.const_214,Tabs.const_342,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_293.startSearch(Tabs.const_290,Tabs.const_205);
         this.var_407.getTab(Tabs.const_290).tabPageDecorator.tabSelected();
      }
