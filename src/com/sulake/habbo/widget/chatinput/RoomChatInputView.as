package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_568:int = 10;
      
      private static const const_917:int = 16;
      
      private static const const_1290:int = 40;
      
      private static const const_1653:int = 5;
      ...
      private var var_350:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1167 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2619 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2618 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_2620 = _loc2_.width + const_917 + _loc6_.width + const_1289;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1290,_loc8_.width) + const_917);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_350 = param1 - this.var_2620;
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),this.var_350);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,this.var_350);
         }
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1167 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_505 = "";
               }
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_350)
         {
