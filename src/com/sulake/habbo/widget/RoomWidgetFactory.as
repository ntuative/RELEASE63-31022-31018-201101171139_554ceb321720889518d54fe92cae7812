package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2717:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2717 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_371:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this._localizations,this.var_128,this.var_2090++,this);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this._localizations,this);
               break;
            case RoomWidgetEnum.const_499:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this._localizations,this.var_128,this._catalog);
               break;
            case RoomWidgetEnum.const_484:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this._localizations,events,this.var_128);
               break;
            ...
            case RoomWidgetEnum.const_509:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this._localizations,this.var_128);
               break;
            ...
            case RoomWidgetEnum.const_536:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this._localizations,this.var_128);
               break;
            case RoomWidgetEnum.const_604:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this._localizations,this.var_128);
               break;
            case RoomWidgetEnum.const_104:
               _loc2_ = new VoteWidget(this._windowManager,assets,this._localizations,this.var_128);
               break;
