package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1280:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_167.state = RoomChatHistoryPulldown.const_260;
         ...
         this.var_45 = param2.createWindow("chatscroller","",HabboWindowType.const_1135,HabboWindowStyle.const_37,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_167.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_260);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_167.state == RoomChatHistoryPulldown.const_351 || this.var_167.state == RoomChatHistoryPulldown.const_485;
      }
      ...
      {
         if(!this.var_406 && !this.var_1481)
         {
            this.var_406 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_167.state = RoomChatHistoryPulldown.const_351;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_45 != null)
         {
            ...
            if(param2)
            {
               this.var_45.scrollV = this.var_598;
            }
         }
         if(this.var_167 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_405 > 0 && param2)
         {
            if(this.var_1788)
            {
               if(Math.abs(param1 - this.var_405) <= const_1037)
               {
                  return;
               }
               this.var_1788 = false;
            ...
            if(this.var_406)
            {
               ...
               _loc5_ = (param1 - this.var_405) / this.var_45.height;
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_45.scrollV < 1 - const_1280 / this.var_45.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1789)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_45 != null)
         {
            this.var_598 = this.var_45.scrollV;
         }
         if(this.var_45 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_598 - this.var_45.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
