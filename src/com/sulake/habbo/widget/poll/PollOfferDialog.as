package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1502:String = "POLL_OFFER_STATE_OK";
      
      public static const const_773:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_537:String = "POLL_OFFER_STATE_UNKNOWN";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     this._state = const_1502;
                     this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_700,this._id));
                     break;
                  case "poll_offer_button_cancel":
                     this._state = const_773;
                     this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_431,this._id));
