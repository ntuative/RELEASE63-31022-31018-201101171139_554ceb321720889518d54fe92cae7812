package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private const const_1645:int = 39;
      
      private const const_1643:int = 7829367;
      
      private const const_1644:int = 16777215;
      
      private const const_1937:int = 2000;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1643;
            }
            else
            {
               _loc3_.textColor = this.const_1644;
            }
            _loc3_.enable();
         }
         else
         ...
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_383,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_383,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_169);
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_1027:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1109:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2510 > this.const_1937 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2510 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1643;
            if(_loc3_.length >= this.const_1645)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1645 - 1);
            }
         }
      }
