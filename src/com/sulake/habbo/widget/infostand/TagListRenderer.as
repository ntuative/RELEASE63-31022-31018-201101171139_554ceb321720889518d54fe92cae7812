package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1906:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_153:Function;
      
      private var _offsetX:int;
      
      private var var_1029:int;
      
      private var var_1030:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1029 = 0;
         this.var_1030 = param2.rectangle.clone();
         this.var_1030.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1030.width)
         {
            return false;
         }
         if(this.var_1029 + param1.height > this.var_1030.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1030.width)
         {
            this._offsetX = 0;
            this.var_1029 += param1.height + this.const_1906;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1029);
         this._offsetX += param1.width + this.const_1907;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1266 != null && this.var_1266.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_153);
