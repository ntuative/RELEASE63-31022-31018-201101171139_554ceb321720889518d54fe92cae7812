package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_891 = this.var_209.findChildByTag("catalog");
         if(this.var_891 != null)
         {
            this.var_891.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_49.addListItem(this.var_891);
            }
            this.var_891.visible = param1;
         }
         else
         {
            this.var_49.removeListItem(this.var_891);
         }
      }
   }
}
