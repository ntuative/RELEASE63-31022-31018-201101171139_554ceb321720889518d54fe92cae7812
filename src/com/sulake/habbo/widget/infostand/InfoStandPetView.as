package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1925:int = 158;
      
      private const const_1927:int = 16;
      
      private const const_1928:uint = 11184810;
      
      private const const_1923:uint = 6710886;
      
      private const const_1924:uint = 3355443;
      
      private const const_1922:String = "level";
      
      private const const_1921:String = "experience";
      
      private const const_1926:String = "energy";
      
      private const const_1929:String = "nutrition";
      ...
      {
         if(this.var_49 == null || this.var_209 == null || this.var_63 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_209.width,this.var_63.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_209.width < this.var_63.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1922,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1921,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1926,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1929,param1.nutrition,param1.nutritionMax);
         ...
         this.updateWindow();
         this.var_503 = param1.id;
         this.var_1333.remove(param1.id);
         this.var_1333.add(param1.id,param1);
         if(this.var_185 && this.var_185.isVisible() && param1.isOwnPet)
         {
            this.var_185.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_185.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1925,this.const_1927,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1928);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1924);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1923);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         if(this.var_185 == null)
         {
            this.var_185 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this.var_1333.getValue(this.var_503) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_185.showWindow(true);
            this.var_185.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_185 && this.var_185.getPetId() == this.var_503)
               {
                  this.var_185.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_488,this._widget.petData.ownerId);
