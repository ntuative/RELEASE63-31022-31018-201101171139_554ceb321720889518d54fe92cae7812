package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class ImageDownloader implements IDisposable
   {
      ...
      private var var_38:AssetLoaderStruct;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_38)
         {
            this.var_38.removeEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,this.onImageReady);
         }
         this.var_38 = null;
         this._disposed = true;
      }
      ...
      public function downloadImage(param1:String, param2:String) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_38 = this._assets.loadAssetFromFile(param2,_loc3_,"image/png");
            this.var_38.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,this.onImageReady);
         }
      }
