package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_54,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1270,const_1269,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1438 = _loc2_.light;
         if(this.var_419 != null)
         {
            this.var_419.setValue(this.var_1438);
         }
         this.var_464 = this.colors.indexOf(_loc2_.color);
         if(this.var_623 != null)
         {
            this.var_623.setSelectedColorIndex(this.var_464);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1437 = XML(_loc1_.content);
         return this.var_1437;
      }
