package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_901:String = "Boy";
      
      private static const const_902:String = "Girl";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_1048,this.onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_325,this.onUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_1048,this.onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_325,this.onUpdate);
      }
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_375:
               ...
               break;
            case RoomWidgetClothingChangeUpdateEvent.const_325:
               this.hideEditorInterface();
         }
      }
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         this.var_2251 = param1.objectCategory;
         ...
         _loc4_ = this._window.findChildByName(const_901);
         if(_loc4_ != null)
         {
      ...
      private function hideEditorInterface() : void
      {
         ...
         {
            _loc1_ = this.var_716 as IFrameWindow;
            if(_loc1_ != null)
            {
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         this.var_716 = _loc4_;
         this.var_716.offset(100,100);
         var _loc6_:IWindow = this.var_716.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = this.onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_332,param1,this.var_356,this.var_2251,this._roomId,this._roomCategory,_loc5_);
