package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_494:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_494.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_494 = null;
         }
         if(this.var_42 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_274,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_274,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_494 == null)
         {
            this.var_494 = new Sprite();
            this.var_494.addChild(new Bitmap(this.var_42));
            this.var_494.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_494.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_42;
            }
         }
         _loc2_.setDisplayObject(this.var_494);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1213 != "")
         {
            HabboWebTools.openWebPage(this.var_1213);
         }
      }
   }
}
