package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_504:String = "LEFT";
      
      private var var_152:Number = 50;
      
      private var var_1164:Boolean = true;
      
      private var var_1165:Number = 1;
      
      private var var_1421:Number = 0;
      
      private var var_1839:Number = 15;
      
      private var var_1840:Number = 5;
      
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         this.var_2748 = new Array();
         ...
         this.var_216 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_54,HabboWindowStyle.const_1034,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1164 = String(_loc6_.relocate_by_drag.@state) == "OutfitView";
         if(this.var_1164)
         {
         ...
         this.var_1165 = _loc6_.toolbar.@margin_top;
         this.var_1421 = _loc6_.toolbar.@margin_bottom;
         this.var_1839 = _loc6_.toolbar.@min_group_margin;
         this.var_1840 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_292 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_256,param1,param2,this._window,this.var_292);
         this.createGroupsFromXmlList(_loc8_,this.var_612,param1,param2,this.var_216,this.var_292);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,this._events,param5,param6,this.var_152);
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_152,this.var_504,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_504);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_152,this.var_504);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_152,this.var_504);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_216.x = this.var_152 + this.var_1840;
               this.var_216.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_216.x = 0;
               this.var_216.y = this.var_152 + this.var_1840;
         ...
         _loc4_ -= this.var_1421;
         _loc4_ -= this.var_1165;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1165;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_256.length > 1)
            {
               if(this.orientation == "LEFT" || this.orientation == "RIGHT")
               {
                  _loc6_ = Number(Math.max(this.var_1839,(this._window.height - _loc5_ * _loc8_ - this.var_1165 - this.var_1421) / (this.var_256.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1839,(this._window.width - _loc5_ * _loc8_ - this.var_1165 - this.var_1421) / (this.var_256.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_256.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_504;
