   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_813.push(new XML());
               this.var_814.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_814[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1257 == true || this.var_816 == 0)
         {
      ...
      {
         return this.var_1257 == false && this.var_816 == 1 && this.var_1537 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_814.length)
         {
            _loc2_ = this.var_814[this._frame];
