package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_602:ToolbarBarMenuAnimator;
      ...
      {
         return this.var_1311.indexOf(param1) > -1;
      }
               ...
               if(!this.containsIcon(_loc2_))
               {
                  ...
                  if(_loc5_.length() > 0)
                  {
                     ...
                     while(_loc9_ < _loc5_.length())
                     {
                        ...
                        _loc6_.dockMenu(_loc3_,this.getMenuYieldList(_loc3_),_loc5_[_loc9_].@locktoicon == "OutfitView");
                        _loc9_++;
                     }
                  }
                  else
                  {
                     this.var_1311.push(_loc2_);
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2290.elements("menu");
         var _loc5_:int = 0;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_700.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      public function get size() : Number
      {
         ...
         {
            if(this.var_280[_loc2_].exists)
            {
               _loc1_ += this.var_1312;
            }
            _loc2_++;
         }
         return _loc1_;
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1313.length)
         {
            _loc2_ = this.var_700.indexOf(this.var_1313[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_280[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1144 + _loc3_);
                  _loc3_ += this.var_1312;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_280[this.var_700.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,this._windowManager,this._assetLibrary,param1,this._events,this.var_602);
         this.var_37.addChild(_loc2_.window);
         this.var_700.push(param1);
         this.var_280.push(_loc2_);
         return _loc2_;
      }
   }
}
