package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1210:Number = 25;
      
      private static const const_1304:Number = 90;
      
      private static const const_880:int = 50;
      
      private static const const_1209:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1267:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_542 = new Object();
         this.var_541 = new Array();
         this.var_543 = new Array();
         super();
         this._windowManager = param1;
         this.var_1267 = param2;
         this.var_664 = new Timer(const_1210);
         this.var_664.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      {
         return param1.x + param1.width < const_880 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_880 || param1.desktop.height - param1.y < const_1209;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1267.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = this.var_1267.getIconLoc(param1.iconId);
      ...
      {
         return this.var_541[this.var_543.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_543[this.var_541.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_543.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_543.splice(_loc3_,1);
            this.var_541.splice(_loc3_,1);
         }
         this.var_541.push(param1.name);
         this.var_543.push(param2);
         param1.addEventListener(WindowEvent.const_329,this.windowEventListener);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_542[_loc3_] == null)
            {
               this.var_542[_loc3_] = new Array();
            }
            if(this.var_542[_loc3_].indexOf(param1) < 0)
            {
               this.var_542[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < this.var_541.length)
         {
            ...
            {
               _loc3_ = this.var_543[_loc2_];
               if(this.var_542[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_542[_loc3_].length)
                  {
                     this.repositionWindow(this.var_542[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
