package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_403:uint = 3;
      
      private static const const_1308:uint = 1;
      ...
      private var var_952:IWindowRenderer;
      
      private var var_930:ISkinContainer;
      
      private var var_360:Array;
      
      private var var_1447:IEventDispatcher;
      
      private var var_1186:Boolean = false;
      
      private var var_1890:ProfilerOutput;
      
      private var var_1448:ProfilerAgentTask;
      
      private var var_1446:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_930 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_952 = new WindowRenderer(this.var_930);
         this.var_191 = new Array(const_403);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_403)
         {
            this.var_191[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_952,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this._windowContext = this.var_191[const_1308];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_390,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1376,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1890)
            {
               this.var_1890 = new ProfilerOutput(context,this,this.var_952);
            }
            this.var_1890.profiler = _loc3_;
            this.var_1448 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1448);
            this.var_1446 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1446);
            this.var_1186 = true;
         }
      }
      ...
      {
         var _loc3_:Dictionary = this.var_360[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_360[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_930.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_361.length > 0)
         {
            this.var_1447.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_403 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1447.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_403)
         {
         ...
         if(WindowContext.var_361.length > 0)
         {
            WindowContext.var_361.flush();
         }
         this.var_1447.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1428,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1557,param2.name + ": " + param2.toString());
            }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_451,
            "style":WindowStyle.const_166,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
