package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_607,0,this.var_370.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      {
         this._startIndex = Math.min(this._startIndex,this.var_116.length - this.var_370.getTabCount());
         this._startIndex = Math.max(0,this._startIndex);
      }
      
      private function getOnlineInfoMsg(param1:Boolean) : Message
      {
         return new Message(Message.const_617,0,this.getOnlineText(param1),Util.getFormattedNow());
      }
