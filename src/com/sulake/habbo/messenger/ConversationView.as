package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1292:int = 10;
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_921 + const_1293)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1292;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_508 == null || _loc1_.id != this.var_508.id)
         {
            this.var_508 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_508.followingAllowed)
         {
            this.var_1856.enable();
         }
         else
         {
            this.var_1856.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_54.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_508.messages.length - const_921);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_508.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_508.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_771 || param3.type == Message.const_601 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_508.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_121.send(new FollowFriendMessageComposer(this.var_508.id));
      }
