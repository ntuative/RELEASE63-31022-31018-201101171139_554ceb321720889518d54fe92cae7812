package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class ConditionTypes implements ElementTypeHolder
   {
      ...
      public function ConditionTypes()
      {
         ...
         super();
         this.var_124.push(new ActorIsOnFurni());
         this.var_124.push(new FurnisHaveAvatars());
         this.var_124.push(new StatesMatch());
         this.var_124.push(new TimeElapsedMore());
         this.var_124.push(new TimeElapsedLess());
         this.var_124.push(new UserCountIn());
         this.var_124.push(new ActorIsInTeam());
         this.var_124.push(new HasStackedFurnis());
         this.var_124.push(new StuffTypeMatches());
      }
