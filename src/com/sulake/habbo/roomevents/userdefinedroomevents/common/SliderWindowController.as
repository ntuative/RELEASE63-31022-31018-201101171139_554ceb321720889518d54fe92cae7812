package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1058:Number = 1.0;
      
      private var var_563:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1058,param1);
         this.var_844 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_844);
         }
      ...
      {
         return int(this.var_1604 * (Number(param1 - this._minValue) / (this.var_1058 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1604 * (this.var_1058 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_843)
         {
            if(param1.type == WindowMouseEvent.const_58 || param1.type == WindowMouseEvent.const_236)
            {
               this.var_843 = false;
            }
         }
         if(!this.var_843 || param1.type != WindowEvent.const_329)
         {
            return;
         }
         if(this.var_563 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_563) * this.var_563;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_563 != 0)
            {
               _loc3_ = this.var_844 + this.var_563;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_686 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_686.width,this.var_686.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_686,this.var_686.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_685 != null)
            {
               ...
               this.var_1604 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_686 = BitmapData(_loc2_.content);
