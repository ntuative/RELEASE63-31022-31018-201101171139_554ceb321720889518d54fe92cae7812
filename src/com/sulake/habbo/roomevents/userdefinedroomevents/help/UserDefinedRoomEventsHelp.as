package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1874 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1174 = this.var_1874.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1174)
         {
            this.var_1174.procedure = this.onButtonClick;
         }
         this.var_1175 = this.var_1874.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1175)
         {
      ...
      {
         if(this.var_258 >= this._localizations.length - 1)
         {
         ...
         if(this.var_258 <= 0)
         {
            this.var_1174.disable();
         }
         else
         {
            this.var_1174.enable();
         }
      }
      ...
      {
         ++this.var_258;
         this.var_258 = Math.min(this.var_258,this._localizations.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this._localizations[this.var_258][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this._localizations[this.var_258][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this._localizations[this.var_258][1]).value;
