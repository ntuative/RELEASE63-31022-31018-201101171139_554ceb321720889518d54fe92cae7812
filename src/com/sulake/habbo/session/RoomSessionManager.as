package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1642)
         {
            this.gotoRoom(this.var_2318,this.var_2316,this.var_1643);
            this.var_1642 = false;
            this.var_1643 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_218,_loc7_));
         return true;
      }
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               ...
               case RoomSessionHandler.const_989:
                  break;
               case RoomSessionHandler.const_668:
