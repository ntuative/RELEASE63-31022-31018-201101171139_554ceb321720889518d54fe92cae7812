package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2512:PseudoRandom;
      ...
      private var var_210:HabboHotelView;
      
      private var var_1378:String = "";
      
      private const const_1630:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_594 = param1;
            this.var_47.initConnection(HabboConnectionType.const_215);
         }
      }
      ...
      {
         if(this.var_47 && this.var_128 && this.var_17 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_210 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this.var_128.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_128.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_210.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_128.getKey("use.sso.ticket") == "1";
         this.var_594 = this.var_128.getKey("sso.ticket",null);
         this.var_1771 = this.var_128.getKey("flash.client.url","");
         this.var_2514 = this.var_128.getKey("external.variables.txt","");
         if(this.var_210 == null)
         {
            this.var_210 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_428,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_47.mode = HabboConnectionType.const_987;
            }
         }
         this.var_47.initConnection(HabboConnectionType.const_215);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_674);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2512 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_47.mode)
         {
            case HabboConnectionType.const_115:
               _loc6_ = "";
               _loc6_ = this.var_128.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_128.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1378 = _loc4_;
               this.var_210.loadBannerImage(_loc7_ + "?token=" + this.var_1378,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_987:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1581:
               this.var_913 = this.generateRandomHexString(30);
               this.var_495 = new DiffieHellman(new BigInteger(this.var_128.getKey("connection.development.prime"),16),new BigInteger(this.var_128.getKey("connection.development.generator"),16));
               this.var_495.init(this.var_913);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2512);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1771,this.var_2514));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1630,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_594 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_594);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2513)
         {
            _loc2_ = this.var_128.getKey("logout.disconnect.url");
            if(this.var_128.keyExists("facebook.user"))
            {
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2513 = true;
         var _loc2_:String = this.var_128.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_128.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
