package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_428:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_142.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_122,HabboWindowStyle.const_37,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1630,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_142.habboConfiguration.getKey("use.sso","false") == "OutfitView")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1630,"/");
         ...
         {
            dispatchEvent(new Event(const_428));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_120.removeEventListener(SSOTicket.const_358,this.onParsedTicketSuccess);
            this.var_120.removeEventListener(SSOTicket.const_262,this.onParsedTicketFailure);
            this.var_120 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_120 = new SSOTicket(this.var_142.assets,_loc3_,_loc2_,param1);
         this.var_120.addEventListener(SSOTicket.const_358,this.onParsedTicketSuccess);
         this.var_120.addEventListener(SSOTicket.const_262,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_142.shockwaveClientUrl = this.var_120.shockwaveClientUrl;
         this.var_142.ssoTicket = this.var_120.ticket;
         this.var_120.removeEventListener(SSOTicket.const_358,this.onParsedTicketSuccess);
         this.var_120.removeEventListener(SSOTicket.const_262,this.onParsedTicketFailure);
         this.var_120 = null;
         dispatchEvent(new Event(const_428));
