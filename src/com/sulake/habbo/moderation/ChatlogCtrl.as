package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_910:Array = [];
      
      private static var var_1764:int = 1000;
      
      private static var var_911:Array = [];
      
      private static var var_1763:int = 200;
      ...
      private var var_1621:IMessageComposer;
      ...
      {
         this.var_728 = IWindowContainer(this.var_32.getXmlWindow("chatlog_roomheader"));
         this.var_729 = IWindowContainer(this.var_32.getXmlWindow("chatlog_chatline"));
         this.var_465 = new Timer(1000,1);
         ...
         this.var_32.connection.send(this.var_1621);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_910.pop() as IWindowContainer;
         }
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_911.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1765[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1369.getValue(param2.chatterName))
            {
               this.var_1369.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1369.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1370)
         {
