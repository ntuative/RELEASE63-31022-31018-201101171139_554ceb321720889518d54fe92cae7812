package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_440:ITextFieldWindow;
      
      private var var_546:Boolean = true;
      
      private var var_859:ICheckBoxWindow;
      
      private var var_1317:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_32.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_304));
         Logger.log("BEGINNING TO SHOW: " + this.var_304);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_304);
         if(param1.flatId != this.var_304)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_304);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_440 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_440.procedure = this.onInputClick;
         ...
         this.var_859 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1317 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1318 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_32,WindowTracker.const_621,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_546 || this.var_440.text == "")
         {
            this.var_32.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_859.isSelected);
         this.var_32.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1567,_loc2_,this.var_440.text,"",""));
         if(this.var_1317.isSelected || this.var_1318.isSelected || this.var_859.isSelected)
         {
            this.var_32.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1317.isSelected,this.var_1318.isSelected,this.var_859.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1516);
         }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_32.initMsg.roomMessageTemplates[this.var_1019.selection];
         if(_loc3_ != null)
         {
            this.var_546 = false;
            this.var_440.text = _loc3_;
         }
      }
   }
}
