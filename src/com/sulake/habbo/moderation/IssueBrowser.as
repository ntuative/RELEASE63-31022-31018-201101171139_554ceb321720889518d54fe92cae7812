package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1933:String = "my_issues";
      
      private const const_1931:String = "open_issues";
      
      private const const_1932:String = "picked_issues";
      
      private const const_1944:String = "closed_issues";
      ...
      private var var_1712:IIssueBrowserView;
      
      private var var_1713:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            while(_loc6_ < this.var_244.numTabItems)
            {
               ...
               _loc5_.addEventListener(WindowEvent.const_55,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_244 = this._window.findChildByName("tab_context") as ITabContextWindow;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_336.view.width = this.var_244.container.width;
         this.var_336.view.height = this.var_244.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1933:
               if(this.var_1711 == null)
               {
                  this.var_1711 = new MyIssuesView(this.issueManager,this,this.var_244.container);
               }
               return this.var_1711;
            case this.const_1931:
               if(this.var_1712 == null)
               {
                  this.var_1712 = new OpenIssuesView(this.issueManager,this,this.var_244.container);
               }
               return this.var_1712;
            case this.const_1932:
               if(this.var_1713 == null)
               {
                  this.var_1713 = new PickedIssuesView(this.issueManager,this,this.var_244.container);
               }
