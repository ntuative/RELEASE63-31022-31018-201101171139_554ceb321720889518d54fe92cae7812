package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1855:int = 200;
      ...
      {
         this.var_758 = IWindowContainer(this.var_32.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1483;
      }
