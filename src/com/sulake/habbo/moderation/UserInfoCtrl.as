package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_898:int = 60;
      
      private static const const_897:int = 3600;
      
      private static const const_899:int = 86400;
      
      private static const const_896:int = 31536000;
      ...
      private var var_1094:IWindowContainer;
      ...
      {
         if(param1 < 2 * const_898)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_897)
         {
            return Math.round(param1 / const_898) + " mins ago";
         }
         if(param1 < 2 * const_899)
         {
            return Math.round(param1 / const_897) + " hours ago";
         }
         if(param1 < 2 * const_896)
         {
            return Math.round(param1 / const_899) + " days ago";
         }
         return Math.round(param1 / const_896) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1094.findChildByName("user_info"));
         if(_loc1_ == null)
         {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_32,WindowTracker.const_1082,this._data.userId),this._callerFrame,this.var_1095,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new RoomVisitsCtrl(this.var_32,this._data.userId),this._callerFrame,this.var_1095,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new SendMsgsCtrl(this.var_32,this._data.userId,this._data.userName,this.var_1231),this._callerFrame,this.var_1095,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new ModActionCtrl(this.var_32,this._data.userId,this._data.userName,this.var_1231),this._callerFrame,this.var_1095,false,true);
      }
