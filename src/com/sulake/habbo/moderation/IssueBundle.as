package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_699:IssueMessageData = null;
      
      private var var_698:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2288 = param2.pickerUserId;
         this.var_2289 = param2.pickerUserName;
         this.var_1368 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1074 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1073;
         }
         if(this.var_699 == null || param1.timeStamp < this.var_699.timeStamp)
         {
            this.var_699 = param1;
         }
         if(this.var_698 == null || param1.priority > this.var_698.timeStamp)
         {
            this.var_698 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1074 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1073;
            }
            if(this.var_699 == _loc2_)
            {
               this.var_699 = null;
            }
            if(this.var_698 == _loc2_)
            {
               this.var_698 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_698;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_699;
         if(_loc2_ == null)
         {
