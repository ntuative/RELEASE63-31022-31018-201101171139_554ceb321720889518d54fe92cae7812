package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1897:String = "type_sound_machine";
      
      private const const_1612:String = "type_jukebox";
      
      private var var_545:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_654,this.onSongFinishedPlayingEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_626,this.onSoundMachinePlayEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_650,this.onSoundMachineStopEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_703,this.onJukeboxInitEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_426,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_654,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_86)
            {
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_626,this.onSoundMachinePlayEvent);
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_650,this.onSoundMachineStopEvent);
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_703,this.onJukeboxInitEvent);
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_426,this.onDisposeEvent);
               this.var_86 = null;
            }
            if(this.var_373)
            {
      ...
      {
         this.startPlaying(this.const_1897);
      }
      ...
      {
         this.startPlaying(this.const_1612);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_272 = _loc2_.id;
            this.playSong(this.var_272);
         }
      }
      
      public function checkSongPlayState(param1:int) : void
      {
         if(this.var_272 == param1)
         {
            this.playSong(this.var_272);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_373[this.var_272] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_373.getValue(this.var_272) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_272 = param1;
         var _loc2_:IHabboSound = this.var_373.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_545.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_545.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_272)
         {
            _loc6_ = this.var_373[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1512 == this.const_1612)
         {
            this.var_73.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_)
         {
            _loc7_ = this.var_373[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_545.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_373.add(_loc3_.id,_loc7_);
            }
