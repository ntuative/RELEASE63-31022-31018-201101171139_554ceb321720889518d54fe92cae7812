package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_903:TraxSequencer;
      
      private var var_591:PlayListController;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1009,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_905.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               ...
               case HabboSoundTypesEnum.const_1366:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1526:
                  _loc3_ = "sound_console_new_message";
                  break;
               case HabboSoundTypesEnum.const_1432:
               ...
               case HabboSoundTypesEnum.const_1166:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1496:
            ...
            this.var_905.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_492;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_170.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_170.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_726.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_726,events);
         _loc8_.volume = this.var_492;
         this.var_903 = null;
         this.var_725 = -1;
         if(_loc5_.length != 0)
         {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_904.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_904 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_170 == null || this._connection == null || this._roomEngine == null || this.var_591 != null)
         {
            return;
         }
         this.var_591 = new PlayListController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onSampleLoadComplete(param1:Event) : void
      {
         ...
         this.var_726.add(_loc3_,_loc6_);
         if(this.var_590.length == 0 && this.var_725 != -1)
         {
            this.var_903.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1009,this.var_725));
            this.var_725 = -1;
            this.var_903 = null;
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_591.checkSongPlayState(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1388,this.var_725));
         this.var_725 = -1;
         this.var_903 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_492 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_492 * 100)));
         }
      }
      ...
      {
         this.var_492 = param1;
         this.var_591.updateVolume(this.var_492);
